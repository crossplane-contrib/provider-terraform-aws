...
package v1alpha1func EncodeConfigDeliveryChannel(r ConfigDeliveryChannel) cty.Value {
...
func EncodeConfigDeliveryChannel_SnapshotDeliveryProperties(p *SnapshotDeliveryProperties, vals map[string]cty.Value) {
	...
	for _, v := range p.SnapshotDeliveryProperties {
		ctyVal = make(map[string]cty.Value)
		EncodeConfigDeliveryChannel_SnapshotDeliveryProperties_DeliveryFrequency(v, ctyVal)
