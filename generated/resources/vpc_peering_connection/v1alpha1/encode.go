...
package v1alpha1func EncodeVpcPeeringConnection(r VpcPeeringConnection) cty.Value {
...
func EncodeVpcPeeringConnection_Requester(p *Requester, vals map[string]cty.Value) {
	...
	for _, v := range p.Requester {
		...
		EncodeVpcPeeringConnection_Requester_AllowClassicLinkToRemoteVpc(v, ctyVal)
		EncodeVpcPeeringConnection_Requester_AllowRemoteVpcDnsResolution(v, ctyVal)
		EncodeVpcPeeringConnection_Requester_AllowVpcToRemoteClassicLink(v, ctyVal)
...
func EncodeVpcPeeringConnection_Accepter(p *Accepter, vals map[string]cty.Value) {
	...
	for _, v := range p.Accepter {
		ctyVal = make(map[string]cty.Value)
		EncodeVpcPeeringConnection_Accepter_AllowVpcToRemoteClassicLink(v, ctyVal)
		EncodeVpcPeeringConnection_Accepter_AllowClassicLinkToRemoteVpc(v, ctyVal)
		EncodeVpcPeeringConnection_Accepter_AllowRemoteVpcDnsResolution(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
