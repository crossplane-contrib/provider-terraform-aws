...
func (mg *Ec2TransitGatewayVpcAttachmentAccepter) GetCondition(ct runtimev1alpha1.ConditionType) runtimev1alpha1.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this Ec2TransitGatewayVpcAttachmentAccepter.
func (mg *Ec2TransitGatewayVpcAttachmentAccepter) GetDeletionPolicy() runtimev1alpha1.DeletionPolicy {
...
*/
func (mg *Ec2TransitGatewayVpcAttachmentAccepter) GetProviderReference() *runtimev1alpha1.Reference {
...
func (mg *Ec2TransitGatewayVpcAttachmentAccepter) SetConditions(c ...runtimev1alpha1.Condition) {
	mg.Status.SetConditions(c...)
}

// SetDeletionPolicy of this Ec2TransitGatewayVpcAttachmentAccepter.
func (mg *Ec2TransitGatewayVpcAttachmentAccepter) SetDeletionPolicy(r runtimev1alpha1.DeletionPolicy) {
...
*/
func (mg *Ec2TransitGatewayVpcAttachmentAccepter) SetProviderReference(r *runtimev1alpha1.Reference) {
