...
package v1alpha1func EncodeOpsworksHaproxyLayer(r OpsworksHaproxyLayer) cty.Value {
...
func EncodeOpsworksHaproxyLayer_EbsVolume(p *EbsVolume, vals map[string]cty.Value) {
	...
	for _, v := range p.EbsVolume {
		...
		EncodeOpsworksHaproxyLayer_EbsVolume_MountPoint(v, ctyVal)
		EncodeOpsworksHaproxyLayer_EbsVolume_NumberOfDisks(v, ctyVal)
		EncodeOpsworksHaproxyLayer_EbsVolume_RaidLevel(v, ctyVal)
		EncodeOpsworksHaproxyLayer_EbsVolume_Size(v, ctyVal)
		EncodeOpsworksHaproxyLayer_EbsVolume_Type(v, ctyVal)
		EncodeOpsworksHaproxyLayer_EbsVolume_Encrypted(v, ctyVal)
		EncodeOpsworksHaproxyLayer_EbsVolume_Iops(v, ctyVal)
