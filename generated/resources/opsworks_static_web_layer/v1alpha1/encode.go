...
package v1alpha1func EncodeOpsworksStaticWebLayer(r OpsworksStaticWebLayer) cty.Value {
...
func EncodeOpsworksStaticWebLayer_EbsVolume(p *EbsVolume, vals map[string]cty.Value) {
	...
	for _, v := range p.EbsVolume {
		...
		EncodeOpsworksStaticWebLayer_EbsVolume_NumberOfDisks(v, ctyVal)
		EncodeOpsworksStaticWebLayer_EbsVolume_RaidLevel(v, ctyVal)
		EncodeOpsworksStaticWebLayer_EbsVolume_Size(v, ctyVal)
		EncodeOpsworksStaticWebLayer_EbsVolume_Type(v, ctyVal)
		EncodeOpsworksStaticWebLayer_EbsVolume_Encrypted(v, ctyVal)
		EncodeOpsworksStaticWebLayer_EbsVolume_Iops(v, ctyVal)
		EncodeOpsworksStaticWebLayer_EbsVolume_MountPoint(v, ctyVal)
