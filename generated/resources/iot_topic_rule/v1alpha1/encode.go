...
package v1alpha1func EncodeIotTopicRule(r IotTopicRule) cty.Value {
...
func EncodeIotTopicRule_Sqs(p *Sqs, vals map[string]cty.Value) {
	...
	for _, v := range p.Sqs {
		...
		EncodeIotTopicRule_Sqs_UseBase64(v, ctyVal)
		EncodeIotTopicRule_Sqs_QueueUrl(v, ctyVal)
		EncodeIotTopicRule_Sqs_RoleArn(v, ctyVal)
...
func EncodeIotTopicRule_StepFunctions(p *StepFunctions, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.StepFunctions {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_StepFunctions_ExecutionNamePrefix(v, ctyVal)
		EncodeIotTopicRule_StepFunctions_RoleArn(v, ctyVal)
		EncodeIotTopicRule_StepFunctions_StateMachineName(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_CloudwatchAlarm(p *CloudwatchAlarm, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.CloudwatchAlarm {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_CloudwatchAlarm_AlarmName(v, ctyVal)
		EncodeIotTopicRule_CloudwatchAlarm_RoleArn(v, ctyVal)
		EncodeIotTopicRule_CloudwatchAlarm_StateReason(v, ctyVal)
		EncodeIotTopicRule_CloudwatchAlarm_StateValue(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_Lambda(p *Lambda, vals map[string]cty.Value) {
	...
	for _, v := range p.Lambda {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_Lambda_FunctionArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_S3(p *S3, vals map[string]cty.Value) {
	...
	for _, v := range p.S3 {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_S3_BucketName(v, ctyVal)
		EncodeIotTopicRule_S3_Key(v, ctyVal)
		EncodeIotTopicRule_S3_RoleArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction(p *ErrorAction, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.ErrorAction {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_Republish(v.Republish, ctyVal)
		EncodeIotTopicRule_ErrorAction_S3(v.S3, ctyVal)
		EncodeIotTopicRule_ErrorAction_Dynamodbv2(v.Dynamodbv2, ctyVal)
		EncodeIotTopicRule_ErrorAction_Elasticsearch(v.Elasticsearch, ctyVal)
		EncodeIotTopicRule_ErrorAction_Kinesis(v.Kinesis, ctyVal)
		EncodeIotTopicRule_ErrorAction_Lambda(v.Lambda, ctyVal)
		EncodeIotTopicRule_ErrorAction_Sns(v.Sns, ctyVal)
		EncodeIotTopicRule_ErrorAction_StepFunctions(v.StepFunctions, ctyVal)
		EncodeIotTopicRule_ErrorAction_Firehose(v.Firehose, ctyVal)
		EncodeIotTopicRule_ErrorAction_IotAnalytics(v.IotAnalytics, ctyVal)
		EncodeIotTopicRule_ErrorAction_Sqs(v.Sqs, ctyVal)
		EncodeIotTopicRule_ErrorAction_CloudwatchMetric(v.CloudwatchMetric, ctyVal)
		EncodeIotTopicRule_ErrorAction_Dynamodb(v.Dynamodb, ctyVal)
		EncodeIotTopicRule_ErrorAction_CloudwatchAlarm(v.CloudwatchAlarm, ctyVal)
		EncodeIotTopicRule_ErrorAction_IotEvents(v.IotEvents, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_Republish(p *Republish, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.Republish {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_Republish_Qos(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Republish_RoleArn(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Republish_Topic(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_S3(p *S3, vals map[string]cty.Value) {
	...
	for _, v := range p.S3 {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_S3_BucketName(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_S3_Key(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_S3_RoleArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_Dynamodbv2(p *Dynamodbv2, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.Dynamodbv2 {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_Dynamodbv2_RoleArn(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Dynamodbv2_PutItem(v.PutItem, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_Dynamodbv2_PutItem(p *PutItem, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.PutItem {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_Dynamodbv2_PutItem_TableName(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_Elasticsearch(p *Elasticsearch, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.Elasticsearch {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_Elasticsearch_Endpoint(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Elasticsearch_Id(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Elasticsearch_Index(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Elasticsearch_RoleArn(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Elasticsearch_Type(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_Kinesis(p *Kinesis, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.Kinesis {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_Kinesis_StreamName(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Kinesis_PartitionKey(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Kinesis_RoleArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_Lambda(p *Lambda, vals map[string]cty.Value) {
	...
	for _, v := range p.Lambda {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_Lambda_FunctionArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_Sns(p *Sns, vals map[string]cty.Value) {
	...
	for _, v := range p.Sns {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_Sns_MessageFormat(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Sns_RoleArn(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Sns_TargetArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_StepFunctions(p *StepFunctions, vals map[string]cty.Value) {
	...
	for _, v := range p.StepFunctions {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_StepFunctions_ExecutionNamePrefix(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_StepFunctions_RoleArn(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_StepFunctions_StateMachineName(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_Firehose(p *Firehose, vals map[string]cty.Value) {
	...
	for _, v := range p.Firehose {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_Firehose_DeliveryStreamName(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Firehose_RoleArn(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Firehose_Separator(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_IotAnalytics(p *IotAnalytics, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.IotAnalytics {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_IotAnalytics_ChannelName(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_IotAnalytics_RoleArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_Sqs(p *Sqs, vals map[string]cty.Value) {
	...
	for _, v := range p.Sqs {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_Sqs_QueueUrl(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Sqs_RoleArn(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Sqs_UseBase64(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_CloudwatchMetric(p *CloudwatchMetric, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.CloudwatchMetric {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_CloudwatchMetric_MetricValue(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_CloudwatchMetric_RoleArn(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_CloudwatchMetric_MetricName(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_CloudwatchMetric_MetricNamespace(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_CloudwatchMetric_MetricTimestamp(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_CloudwatchMetric_MetricUnit(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_Dynamodb(p *Dynamodb, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.Dynamodb {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_Dynamodb_HashKeyType(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Dynamodb_HashKeyValue(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Dynamodb_Operation(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Dynamodb_RangeKeyField(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Dynamodb_RangeKeyType(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Dynamodb_TableName(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Dynamodb_HashKeyField(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Dynamodb_PayloadField(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Dynamodb_RangeKeyValue(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_Dynamodb_RoleArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_CloudwatchAlarm(p *CloudwatchAlarm, vals map[string]cty.Value) {
	...
	for _, v := range p.CloudwatchAlarm {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_CloudwatchAlarm_StateValue(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_CloudwatchAlarm_AlarmName(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_CloudwatchAlarm_RoleArn(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_CloudwatchAlarm_StateReason(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_ErrorAction_IotEvents(p *IotEvents, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.IotEvents {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_ErrorAction_IotEvents_InputName(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_IotEvents_MessageId(v, ctyVal)
		EncodeIotTopicRule_ErrorAction_IotEvents_RoleArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_Sns(p *Sns, vals map[string]cty.Value) {
	...
	for _, v := range p.Sns {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_Sns_RoleArn(v, ctyVal)
		EncodeIotTopicRule_Sns_TargetArn(v, ctyVal)
		EncodeIotTopicRule_Sns_MessageFormat(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_Elasticsearch(p *Elasticsearch, vals map[string]cty.Value) {
	...
	for _, v := range p.Elasticsearch {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_Elasticsearch_Id(v, ctyVal)
		EncodeIotTopicRule_Elasticsearch_Index(v, ctyVal)
		EncodeIotTopicRule_Elasticsearch_RoleArn(v, ctyVal)
		EncodeIotTopicRule_Elasticsearch_Type(v, ctyVal)
		EncodeIotTopicRule_Elasticsearch_Endpoint(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_Firehose(p *Firehose, vals map[string]cty.Value) {
	...
	for _, v := range p.Firehose {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_Firehose_DeliveryStreamName(v, ctyVal)
		EncodeIotTopicRule_Firehose_RoleArn(v, ctyVal)
		EncodeIotTopicRule_Firehose_Separator(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_IotAnalytics(p *IotAnalytics, vals map[string]cty.Value) {
	...
	for _, v := range p.IotAnalytics {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_IotAnalytics_RoleArn(v, ctyVal)
		EncodeIotTopicRule_IotAnalytics_ChannelName(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_IotEvents(p *IotEvents, vals map[string]cty.Value) {
	...
	for _, v := range p.IotEvents {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_IotEvents_InputName(v, ctyVal)
		EncodeIotTopicRule_IotEvents_MessageId(v, ctyVal)
		EncodeIotTopicRule_IotEvents_RoleArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_Kinesis(p *Kinesis, vals map[string]cty.Value) {
	...
	for _, v := range p.Kinesis {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_Kinesis_PartitionKey(v, ctyVal)
		EncodeIotTopicRule_Kinesis_RoleArn(v, ctyVal)
		EncodeIotTopicRule_Kinesis_StreamName(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_CloudwatchMetric(p *CloudwatchMetric, vals map[string]cty.Value) {
	...
	for _, v := range p.CloudwatchMetric {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_CloudwatchMetric_RoleArn(v, ctyVal)
		EncodeIotTopicRule_CloudwatchMetric_MetricName(v, ctyVal)
		EncodeIotTopicRule_CloudwatchMetric_MetricNamespace(v, ctyVal)
		EncodeIotTopicRule_CloudwatchMetric_MetricTimestamp(v, ctyVal)
		EncodeIotTopicRule_CloudwatchMetric_MetricUnit(v, ctyVal)
		EncodeIotTopicRule_CloudwatchMetric_MetricValue(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_Dynamodb(p *Dynamodb, vals map[string]cty.Value) {
	...
	for _, v := range p.Dynamodb {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_Dynamodb_HashKeyType(v, ctyVal)
		EncodeIotTopicRule_Dynamodb_HashKeyValue(v, ctyVal)
		EncodeIotTopicRule_Dynamodb_Operation(v, ctyVal)
		EncodeIotTopicRule_Dynamodb_RangeKeyType(v, ctyVal)
		EncodeIotTopicRule_Dynamodb_RangeKeyValue(v, ctyVal)
		EncodeIotTopicRule_Dynamodb_HashKeyField(v, ctyVal)
		EncodeIotTopicRule_Dynamodb_RangeKeyField(v, ctyVal)
		EncodeIotTopicRule_Dynamodb_RoleArn(v, ctyVal)
		EncodeIotTopicRule_Dynamodb_TableName(v, ctyVal)
		EncodeIotTopicRule_Dynamodb_PayloadField(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_Dynamodbv2(p *Dynamodbv2, vals map[string]cty.Value) {
	...
	for _, v := range p.Dynamodbv2 {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_Dynamodbv2_RoleArn(v, ctyVal)
		EncodeIotTopicRule_Dynamodbv2_PutItem(v.PutItem, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeIotTopicRule_Dynamodbv2_PutItem(p *PutItem, vals map[string]cty.Value) {
	...
	for _, v := range p.PutItem {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_Dynamodbv2_PutItem_TableName(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
	vals["put_item"] = cty.ListVal(valsForCollection)
}
...
func EncodeIotTopicRule_Republish(p *Republish, vals map[string]cty.Value) {
	...
	for _, v := range p.Republish {
		ctyVal = make(map[string]cty.Value)
		EncodeIotTopicRule_Republish_Qos(v, ctyVal)
		EncodeIotTopicRule_Republish_RoleArn(v, ctyVal)
		EncodeIotTopicRule_Republish_Topic(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
