...
func EncodeS3Bucket(r S3Bucket) cty.Value {
...
func EncodeS3Bucket_Logging(p Logging, vals map[string]cty.Value) {
	...
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_Logging_TargetBucket(p, ctyVal)
	EncodeS3Bucket_Logging_TargetPrefix(p, ctyVal)
...
func EncodeS3Bucket_ServerSideEncryptionConfiguration(p ServerSideEncryptionConfiguration, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_ServerSideEncryptionConfiguration_Rule(p.Rule, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_ServerSideEncryptionConfiguration_Rule(p Rule, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_ServerSideEncryptionConfiguration_Rule_ApplyServerSideEncryptionByDefault(p.ApplyServerSideEncryptionByDefault, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_ServerSideEncryptionConfiguration_Rule_ApplyServerSideEncryptionByDefault(p ApplyServerSideEncryptionByDefault, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_ServerSideEncryptionConfiguration_Rule_ApplyServerSideEncryptionByDefault_SseAlgorithm(p, ctyVal)
	EncodeS3Bucket_ServerSideEncryptionConfiguration_Rule_ApplyServerSideEncryptionByDefault_KmsMasterKeyId(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_Website(p Website, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_Website_ErrorDocument(p, ctyVal)
	EncodeS3Bucket_Website_IndexDocument(p, ctyVal)
	EncodeS3Bucket_Website_RedirectAllRequestsTo(p, ctyVal)
	EncodeS3Bucket_Website_RoutingRules(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_CorsRule(p CorsRule, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_CorsRule_AllowedMethods(p, ctyVal)
	EncodeS3Bucket_CorsRule_AllowedOrigins(p, ctyVal)
	EncodeS3Bucket_CorsRule_ExposeHeaders(p, ctyVal)
	EncodeS3Bucket_CorsRule_MaxAgeSeconds(p, ctyVal)
	EncodeS3Bucket_CorsRule_AllowedHeaders(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_CorsRule_MaxAgeSeconds(p CorsRule, vals map[string]cty.Value) {
	vals["max_age_seconds"] = cty.NumberIntVal(p.MaxAgeSeconds)
}
...
func EncodeS3Bucket_Grant(p Grant, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_Grant_Uri(p, ctyVal)
	EncodeS3Bucket_Grant_Id(p, ctyVal)
	EncodeS3Bucket_Grant_Permissions(p, ctyVal)
	EncodeS3Bucket_Grant_Type(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_LifecycleRule(p LifecycleRule, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_LifecycleRule_Prefix(p, ctyVal)
	EncodeS3Bucket_LifecycleRule_Tags(p, ctyVal)
	EncodeS3Bucket_LifecycleRule_AbortIncompleteMultipartUploadDays(p, ctyVal)
	EncodeS3Bucket_LifecycleRule_Enabled(p, ctyVal)
	EncodeS3Bucket_LifecycleRule_Id(p, ctyVal)
	EncodeS3Bucket_LifecycleRule_Transition(p.Transition, ctyVal)
	EncodeS3Bucket_LifecycleRule_Expiration(p.Expiration, ctyVal)
	EncodeS3Bucket_LifecycleRule_NoncurrentVersionExpiration(p.NoncurrentVersionExpiration, ctyVal)
	EncodeS3Bucket_LifecycleRule_NoncurrentVersionTransition(p.NoncurrentVersionTransition, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_LifecycleRule_AbortIncompleteMultipartUploadDays(p LifecycleRule, vals map[string]cty.Value) {
	vals["abort_incomplete_multipart_upload_days"] = cty.NumberIntVal(p.AbortIncompleteMultipartUploadDays)
}
...
func EncodeS3Bucket_LifecycleRule_Transition(p Transition, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_LifecycleRule_Transition_Date(p, ctyVal)
	EncodeS3Bucket_LifecycleRule_Transition_Days(p, ctyVal)
	EncodeS3Bucket_LifecycleRule_Transition_StorageClass(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_LifecycleRule_Transition_Days(p Transition, vals map[string]cty.Value) {
	vals["days"] = cty.NumberIntVal(p.Days)
}
...
func EncodeS3Bucket_LifecycleRule_Expiration(p Expiration, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_LifecycleRule_Expiration_ExpiredObjectDeleteMarker(p, ctyVal)
	EncodeS3Bucket_LifecycleRule_Expiration_Date(p, ctyVal)
	EncodeS3Bucket_LifecycleRule_Expiration_Days(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_LifecycleRule_NoncurrentVersionExpiration(p NoncurrentVersionExpiration, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_LifecycleRule_NoncurrentVersionExpiration_Days(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_LifecycleRule_NoncurrentVersionTransition(p NoncurrentVersionTransition, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_LifecycleRule_NoncurrentVersionTransition_Days(p, ctyVal)
	EncodeS3Bucket_LifecycleRule_NoncurrentVersionTransition_StorageClass(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_ObjectLockConfiguration(p ObjectLockConfiguration, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_ObjectLockConfiguration_ObjectLockEnabled(p, ctyVal)
	EncodeS3Bucket_ObjectLockConfiguration_Rule(p.Rule, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_ObjectLockConfiguration_Rule(p Rule, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_ObjectLockConfiguration_Rule_DefaultRetention(p.DefaultRetention, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
	vals["rule"] = cty.ListVal(valsForCollection)
}
...
func EncodeS3Bucket_ObjectLockConfiguration_Rule_DefaultRetention(p DefaultRetention, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_ObjectLockConfiguration_Rule_DefaultRetention_Days(p, ctyVal)
	EncodeS3Bucket_ObjectLockConfiguration_Rule_DefaultRetention_Mode(p, ctyVal)
	EncodeS3Bucket_ObjectLockConfiguration_Rule_DefaultRetention_Years(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_ObjectLockConfiguration_Rule_DefaultRetention_Years(p DefaultRetention, vals map[string]cty.Value) {
	vals["years"] = cty.NumberIntVal(p.Years)
}

func EncodeS3Bucket_ReplicationConfiguration(p ReplicationConfiguration, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_ReplicationConfiguration_Role(p, ctyVal)
	EncodeS3Bucket_ReplicationConfiguration_Rules(p.Rules, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_ReplicationConfiguration_Rules_Filter(p Filter, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_ReplicationConfiguration_Rules_Filter_Prefix(p, ctyVal)
	EncodeS3Bucket_ReplicationConfiguration_Rules_Filter_Tags(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_ReplicationConfiguration_Rules_SourceSelectionCriteria(p SourceSelectionCriteria, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_ReplicationConfiguration_Rules_SourceSelectionCriteria_SseKmsEncryptedObjects(p.SseKmsEncryptedObjects, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_ReplicationConfiguration_Rules_SourceSelectionCriteria_SseKmsEncryptedObjects(p SseKmsEncryptedObjects, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_ReplicationConfiguration_Rules_SourceSelectionCriteria_SseKmsEncryptedObjects_Enabled(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_ReplicationConfiguration_Rules_Destination(p Destination, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_ReplicationConfiguration_Rules_Destination_AccountId(p, ctyVal)
	EncodeS3Bucket_ReplicationConfiguration_Rules_Destination_Bucket(p, ctyVal)
	EncodeS3Bucket_ReplicationConfiguration_Rules_Destination_ReplicaKmsKeyId(p, ctyVal)
	EncodeS3Bucket_ReplicationConfiguration_Rules_Destination_StorageClass(p, ctyVal)
	EncodeS3Bucket_ReplicationConfiguration_Rules_Destination_AccessControlTranslation(p.AccessControlTranslation, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_ReplicationConfiguration_Rules_Destination_AccessControlTranslation(p AccessControlTranslation, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_ReplicationConfiguration_Rules_Destination_AccessControlTranslation_Owner(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeS3Bucket_Versioning(p Versioning, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeS3Bucket_Versioning_Enabled(p, ctyVal)
	EncodeS3Bucket_Versioning_MfaDelete(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
