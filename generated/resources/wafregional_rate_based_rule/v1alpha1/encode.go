...
package v1alpha1func EncodeWafregionalRateBasedRule(r WafregionalRateBasedRule) cty.Value {
...
func EncodeWafregionalRateBasedRule_Predicate(p *Predicate, vals map[string]cty.Value) {
	...
	for _, v := range p.Predicate {
		...
		EncodeWafregionalRateBasedRule_Predicate_DataId(v, ctyVal)
		EncodeWafregionalRateBasedRule_Predicate_Negated(v, ctyVal)
		EncodeWafregionalRateBasedRule_Predicate_Type(v, ctyVal)
