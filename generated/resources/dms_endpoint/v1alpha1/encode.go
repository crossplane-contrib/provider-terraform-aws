...
package v1alpha1func EncodeDmsEndpoint(r DmsEndpoint) cty.Value {
...
func EncodeDmsEndpoint_ElasticsearchSettings(p *ElasticsearchSettings, vals map[string]cty.Value) {
	...
	for _, v := range p.ElasticsearchSettings {
		ctyVal = make(map[string]cty.Value)
		EncodeDmsEndpoint_ElasticsearchSettings_ServiceAccessRoleArn(v, ctyVal)
		EncodeDmsEndpoint_ElasticsearchSettings_EndpointUri(v, ctyVal)
		EncodeDmsEndpoint_ElasticsearchSettings_ErrorRetryDuration(v, ctyVal)
		EncodeDmsEndpoint_ElasticsearchSettings_FullLoadErrorPercentage(v, ctyVal)
...
func EncodeDmsEndpoint_ElasticsearchSettings_ErrorRetryDuration(p *ElasticsearchSettings, vals map[string]cty.Value) {
	vals["error_retry_duration"] = cty.IntVal(p.ErrorRetryDuration)
}

func EncodeDmsEndpoint_ElasticsearchSettings_FullLoadErrorPercentage(p *ElasticsearchSettings, vals map[string]cty.Value) {
	vals["full_load_error_percentage"] = cty.IntVal(p.FullLoadErrorPercentage)
}

func EncodeDmsEndpoint_KafkaSettings(p *KafkaSettings, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.KafkaSettings {
		ctyVal = make(map[string]cty.Value)
		EncodeDmsEndpoint_KafkaSettings_Broker(v, ctyVal)
		EncodeDmsEndpoint_KafkaSettings_Topic(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeDmsEndpoint_KinesisSettings(p *KinesisSettings, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.KinesisSettings {
		ctyVal = make(map[string]cty.Value)
		EncodeDmsEndpoint_KinesisSettings_MessageFormat(v, ctyVal)
		EncodeDmsEndpoint_KinesisSettings_ServiceAccessRoleArn(v, ctyVal)
		EncodeDmsEndpoint_KinesisSettings_StreamArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeDmsEndpoint_MongodbSettings(p *MongodbSettings, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.MongodbSettings {
		ctyVal = make(map[string]cty.Value)
		EncodeDmsEndpoint_MongodbSettings_AuthMechanism(v, ctyVal)
		EncodeDmsEndpoint_MongodbSettings_AuthSource(v, ctyVal)
		EncodeDmsEndpoint_MongodbSettings_AuthType(v, ctyVal)
		EncodeDmsEndpoint_MongodbSettings_DocsToInvestigate(v, ctyVal)
		EncodeDmsEndpoint_MongodbSettings_ExtractDocId(v, ctyVal)
		EncodeDmsEndpoint_MongodbSettings_NestingLevel(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeDmsEndpoint_S3Settings(p *S3Settings, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.S3Settings {
		ctyVal = make(map[string]cty.Value)
		EncodeDmsEndpoint_S3Settings_BucketFolder(v, ctyVal)
		EncodeDmsEndpoint_S3Settings_BucketName(v, ctyVal)
		EncodeDmsEndpoint_S3Settings_CompressionType(v, ctyVal)
		EncodeDmsEndpoint_S3Settings_CsvDelimiter(v, ctyVal)
		EncodeDmsEndpoint_S3Settings_CsvRowDelimiter(v, ctyVal)
		EncodeDmsEndpoint_S3Settings_ExternalTableDefinition(v, ctyVal)
		EncodeDmsEndpoint_S3Settings_ServiceAccessRoleArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
