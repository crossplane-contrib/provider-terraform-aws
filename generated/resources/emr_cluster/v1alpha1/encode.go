...
func EncodeEmrCluster(r EmrCluster) cty.Value {
...
func EncodeEmrCluster_EbsRootVolumeSize(p EmrClusterParameters, vals map[string]cty.Value) {
	vals["ebs_root_volume_size"] = cty.NumberIntVal(p.EbsRootVolumeSize)
}
...
func EncodeEmrCluster_StepConcurrencyLevel(p EmrClusterParameters, vals map[string]cty.Value) {
	vals["step_concurrency_level"] = cty.NumberIntVal(p.StepConcurrencyLevel)
}
...
func EncodeEmrCluster_CoreInstanceFleet(p CoreInstanceFleet, vals map[string]cty.Value) {
	...
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_CoreInstanceFleet_TargetSpotCapacity(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_Id(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_Name(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_ProvisionedOnDemandCapacity(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_ProvisionedSpotCapacity(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_TargetOnDemandCapacity(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs(p.InstanceTypeConfigs, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_LaunchSpecifications(p.LaunchSpecifications, ctyVal)
...
func EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs(p InstanceTypeConfigs, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_BidPrice(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_BidPriceAsPercentageOfOnDemandPrice(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_InstanceType(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_WeightedCapacity(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_Configurations(p.Configurations, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_EbsConfig(p.EbsConfig, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_Configurations(p Configurations, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_Configurations_Properties(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_Configurations_Classification(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_EbsConfig(p EbsConfig, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_EbsConfig_Iops(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_EbsConfig_Size(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_EbsConfig_Type(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_InstanceTypeConfigs_EbsConfig_VolumesPerInstance(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeEmrCluster_CoreInstanceFleet_LaunchSpecifications(p LaunchSpecifications, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_CoreInstanceFleet_LaunchSpecifications_OnDemandSpecification(p.OnDemandSpecification, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_LaunchSpecifications_SpotSpecification(p.SpotSpecification, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeEmrCluster_CoreInstanceFleet_LaunchSpecifications_OnDemandSpecification(p OnDemandSpecification, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_CoreInstanceFleet_LaunchSpecifications_OnDemandSpecification_AllocationStrategy(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeEmrCluster_CoreInstanceFleet_LaunchSpecifications_SpotSpecification(p SpotSpecification, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_CoreInstanceFleet_LaunchSpecifications_SpotSpecification_TimeoutAction(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_LaunchSpecifications_SpotSpecification_TimeoutDurationMinutes(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_LaunchSpecifications_SpotSpecification_AllocationStrategy(p, ctyVal)
	EncodeEmrCluster_CoreInstanceFleet_LaunchSpecifications_SpotSpecification_BlockDurationMinutes(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeEmrCluster_CoreInstanceGroup(p CoreInstanceGroup, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_CoreInstanceGroup_BidPrice(p, ctyVal)
	EncodeEmrCluster_CoreInstanceGroup_Id(p, ctyVal)
	EncodeEmrCluster_CoreInstanceGroup_InstanceCount(p, ctyVal)
	EncodeEmrCluster_CoreInstanceGroup_InstanceType(p, ctyVal)
	EncodeEmrCluster_CoreInstanceGroup_Name(p, ctyVal)
	EncodeEmrCluster_CoreInstanceGroup_AutoscalingPolicy(p, ctyVal)
	EncodeEmrCluster_CoreInstanceGroup_EbsConfig(p.EbsConfig, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeEmrCluster_CoreInstanceGroup_EbsConfig(p EbsConfig, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_CoreInstanceGroup_EbsConfig_Iops(p, ctyVal)
	EncodeEmrCluster_CoreInstanceGroup_EbsConfig_Size(p, ctyVal)
	EncodeEmrCluster_CoreInstanceGroup_EbsConfig_Type(p, ctyVal)
	EncodeEmrCluster_CoreInstanceGroup_EbsConfig_VolumesPerInstance(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
	vals["ebs_config"] = cty.SetVal(valsForCollection)
}
...
func EncodeEmrCluster_Ec2Attributes(p Ec2Attributes, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_Ec2Attributes_ServiceAccessSecurityGroup(p, ctyVal)
	EncodeEmrCluster_Ec2Attributes_SubnetId(p, ctyVal)
	EncodeEmrCluster_Ec2Attributes_AdditionalMasterSecurityGroups(p, ctyVal)
	EncodeEmrCluster_Ec2Attributes_AdditionalSlaveSecurityGroups(p, ctyVal)
	EncodeEmrCluster_Ec2Attributes_EmrManagedMasterSecurityGroup(p, ctyVal)
	EncodeEmrCluster_Ec2Attributes_EmrManagedSlaveSecurityGroup(p, ctyVal)
	EncodeEmrCluster_Ec2Attributes_InstanceProfile(p, ctyVal)
	EncodeEmrCluster_Ec2Attributes_KeyName(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeEmrCluster_KerberosAttributes(p KerberosAttributes, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_KerberosAttributes_Realm(p, ctyVal)
	EncodeEmrCluster_KerberosAttributes_AdDomainJoinPassword(p, ctyVal)
	EncodeEmrCluster_KerberosAttributes_AdDomainJoinUser(p, ctyVal)
	EncodeEmrCluster_KerberosAttributes_CrossRealmTrustPrincipalPassword(p, ctyVal)
	EncodeEmrCluster_KerberosAttributes_KdcAdminPassword(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeEmrCluster_MasterInstanceFleet(p MasterInstanceFleet, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_MasterInstanceFleet_ProvisionedSpotCapacity(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_TargetOnDemandCapacity(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_TargetSpotCapacity(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_Id(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_Name(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_ProvisionedOnDemandCapacity(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs(p.InstanceTypeConfigs, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_LaunchSpecifications(p.LaunchSpecifications, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs(p InstanceTypeConfigs, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_InstanceType(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_WeightedCapacity(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_BidPrice(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_BidPriceAsPercentageOfOnDemandPrice(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_EbsConfig(p.EbsConfig, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_Configurations(p.Configurations, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
	vals["instance_type_configs"] = cty.SetVal(valsForCollection)
}
...
func EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_EbsConfig(p EbsConfig, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_EbsConfig_Iops(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_EbsConfig_Size(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_EbsConfig_Type(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_EbsConfig_VolumesPerInstance(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
	vals["ebs_config"] = cty.SetVal(valsForCollection)
}
...
func EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_Configurations(p Configurations, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_Configurations_Classification(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_InstanceTypeConfigs_Configurations_Properties(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
	vals["configurations"] = cty.SetVal(valsForCollection)
}
...
func EncodeEmrCluster_MasterInstanceFleet_LaunchSpecifications(p LaunchSpecifications, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_MasterInstanceFleet_LaunchSpecifications_OnDemandSpecification(p.OnDemandSpecification, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_LaunchSpecifications_SpotSpecification(p.SpotSpecification, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
	vals["launch_specifications"] = cty.ListVal(valsForCollection)
}
...
func EncodeEmrCluster_MasterInstanceFleet_LaunchSpecifications_OnDemandSpecification(p OnDemandSpecification, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_MasterInstanceFleet_LaunchSpecifications_OnDemandSpecification_AllocationStrategy(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
	vals["on_demand_specification"] = cty.ListVal(valsForCollection)
}
...
func EncodeEmrCluster_MasterInstanceFleet_LaunchSpecifications_SpotSpecification(p SpotSpecification, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_MasterInstanceFleet_LaunchSpecifications_SpotSpecification_AllocationStrategy(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_LaunchSpecifications_SpotSpecification_BlockDurationMinutes(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_LaunchSpecifications_SpotSpecification_TimeoutAction(p, ctyVal)
	EncodeEmrCluster_MasterInstanceFleet_LaunchSpecifications_SpotSpecification_TimeoutDurationMinutes(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
	vals["spot_specification"] = cty.ListVal(valsForCollection)
}
...
func EncodeEmrCluster_MasterInstanceGroup(p MasterInstanceGroup, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_MasterInstanceGroup_InstanceType(p, ctyVal)
	EncodeEmrCluster_MasterInstanceGroup_Name(p, ctyVal)
	EncodeEmrCluster_MasterInstanceGroup_BidPrice(p, ctyVal)
	EncodeEmrCluster_MasterInstanceGroup_Id(p, ctyVal)
	EncodeEmrCluster_MasterInstanceGroup_InstanceCount(p, ctyVal)
	EncodeEmrCluster_MasterInstanceGroup_EbsConfig(p.EbsConfig, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeEmrCluster_MasterInstanceGroup_EbsConfig(p EbsConfig, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_MasterInstanceGroup_EbsConfig_Size(p, ctyVal)
	EncodeEmrCluster_MasterInstanceGroup_EbsConfig_Type(p, ctyVal)
	EncodeEmrCluster_MasterInstanceGroup_EbsConfig_VolumesPerInstance(p, ctyVal)
	EncodeEmrCluster_MasterInstanceGroup_EbsConfig_Iops(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
	vals["ebs_config"] = cty.SetVal(valsForCollection)
}
...
func EncodeEmrCluster_BootstrapAction(p BootstrapAction, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEmrCluster_BootstrapAction_Args(p, ctyVal)
	EncodeEmrCluster_BootstrapAction_Name(p, ctyVal)
	EncodeEmrCluster_BootstrapAction_Path(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
