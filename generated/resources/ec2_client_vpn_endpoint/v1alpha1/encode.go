...
package v1alpha1func EncodeEc2ClientVpnEndpoint(r Ec2ClientVpnEndpoint) cty.Value {
...
func EncodeEc2ClientVpnEndpoint_AuthenticationOptions(p *AuthenticationOptions, vals map[string]cty.Value) {
	...
	for _, v := range p.AuthenticationOptions {
...
func EncodeEc2ClientVpnEndpoint_ConnectionLogOptions(p *ConnectionLogOptions, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.ConnectionLogOptions {
		ctyVal = make(map[string]cty.Value)
		EncodeEc2ClientVpnEndpoint_ConnectionLogOptions_CloudwatchLogGroup(v, ctyVal)
		EncodeEc2ClientVpnEndpoint_ConnectionLogOptions_CloudwatchLogStream(v, ctyVal)
		EncodeEc2ClientVpnEndpoint_ConnectionLogOptions_Enabled(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
