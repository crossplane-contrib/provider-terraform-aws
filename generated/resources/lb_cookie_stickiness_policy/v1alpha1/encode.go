...
package v1alpha1func EncodeLbCookieStickinessPolicy(r LbCookieStickinessPolicy) cty.Value {
...
func EncodeLbCookieStickinessPolicy_CookieExpirationPeriod(p *LbCookieStickinessPolicyParameters, vals map[string]cty.Value) {
	vals["cookie_expiration_period"] = cty.IntVal(p.CookieExpirationPeriod)
}
