...
package v1alpha1func EncodeCodepipelineWebhook(r CodepipelineWebhook) cty.Value {
...
func EncodeCodepipelineWebhook_AuthenticationConfiguration(p *AuthenticationConfiguration, vals map[string]cty.Value) {
	...
	for _, v := range p.AuthenticationConfiguration {
		ctyVal = make(map[string]cty.Value)
		EncodeCodepipelineWebhook_AuthenticationConfiguration_AllowedIpRange(v, ctyVal)
		EncodeCodepipelineWebhook_AuthenticationConfiguration_SecretToken(v, ctyVal)
