...
func (mg *ElasticsearchDomainPolicy) GetCondition(ct runtimev1alpha1.ConditionType) runtimev1alpha1.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this ElasticsearchDomainPolicy.
func (mg *ElasticsearchDomainPolicy) GetDeletionPolicy() runtimev1alpha1.DeletionPolicy {
