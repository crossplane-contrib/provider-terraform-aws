...
package v1alpha1func EncodeOpsworksJavaAppLayer(r OpsworksJavaAppLayer) cty.Value {
...
func EncodeOpsworksJavaAppLayer_EbsVolume(p *EbsVolume, vals map[string]cty.Value) {
	...
	for _, v := range p.EbsVolume {
		...
		EncodeOpsworksJavaAppLayer_EbsVolume_Type(v, ctyVal)
		EncodeOpsworksJavaAppLayer_EbsVolume_Encrypted(v, ctyVal)
		EncodeOpsworksJavaAppLayer_EbsVolume_Iops(v, ctyVal)
		EncodeOpsworksJavaAppLayer_EbsVolume_MountPoint(v, ctyVal)
		EncodeOpsworksJavaAppLayer_EbsVolume_NumberOfDisks(v, ctyVal)
		EncodeOpsworksJavaAppLayer_EbsVolume_RaidLevel(v, ctyVal)
		EncodeOpsworksJavaAppLayer_EbsVolume_Size(v, ctyVal)
