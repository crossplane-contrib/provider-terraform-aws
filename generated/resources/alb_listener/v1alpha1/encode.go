...
package v1alpha1func EncodeAlbListener(r AlbListener) cty.Value {
...
func EncodeAlbListener_DefaultAction_FixedResponse(p *FixedResponse, vals map[string]cty.Value) {
	...
	for _, v := range p.FixedResponse {
		ctyVal = make(map[string]cty.Value)
		EncodeAlbListener_DefaultAction_FixedResponse_StatusCode(v, ctyVal)
		EncodeAlbListener_DefaultAction_FixedResponse_ContentType(v, ctyVal)
		EncodeAlbListener_DefaultAction_FixedResponse_MessageBody(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeAlbListener_DefaultAction_Forward(p *Forward, vals map[string]cty.Value) {
	...
	for _, v := range p.Forward {
		ctyVal = make(map[string]cty.Value)
		EncodeAlbListener_DefaultAction_Forward_TargetGroup(v.TargetGroup, ctyVal)
		EncodeAlbListener_DefaultAction_Forward_Stickiness(v.Stickiness, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeAlbListener_DefaultAction_Forward_Stickiness(p *Stickiness, vals map[string]cty.Value) {
	...
	for _, v := range p.Stickiness {
		ctyVal = make(map[string]cty.Value)
		EncodeAlbListener_DefaultAction_Forward_Stickiness_Duration(v, ctyVal)
		EncodeAlbListener_DefaultAction_Forward_Stickiness_Enabled(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeAlbListener_DefaultAction_Redirect(p *Redirect, vals map[string]cty.Value) {
	...
	for _, v := range p.Redirect {
		ctyVal = make(map[string]cty.Value)
		EncodeAlbListener_DefaultAction_Redirect_Host(v, ctyVal)
		EncodeAlbListener_DefaultAction_Redirect_Path(v, ctyVal)
		EncodeAlbListener_DefaultAction_Redirect_Port(v, ctyVal)
		EncodeAlbListener_DefaultAction_Redirect_Protocol(v, ctyVal)
		EncodeAlbListener_DefaultAction_Redirect_Query(v, ctyVal)
		EncodeAlbListener_DefaultAction_Redirect_StatusCode(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeAlbListener_DefaultAction_AuthenticateCognito(p *AuthenticateCognito, vals map[string]cty.Value) {
	...
	for _, v := range p.AuthenticateCognito {
		ctyVal = make(map[string]cty.Value)
		EncodeAlbListener_DefaultAction_AuthenticateCognito_SessionTimeout(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateCognito_UserPoolArn(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateCognito_UserPoolClientId(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateCognito_UserPoolDomain(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateCognito_AuthenticationRequestExtraParams(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateCognito_OnUnauthenticatedRequest(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateCognito_Scope(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateCognito_SessionCookieName(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeAlbListener_DefaultAction_AuthenticateOidc(p *AuthenticateOidc, vals map[string]cty.Value) {
	...
	for _, v := range p.AuthenticateOidc {
		ctyVal = make(map[string]cty.Value)
		EncodeAlbListener_DefaultAction_AuthenticateOidc_ClientSecret(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateOidc_Issuer(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateOidc_OnUnauthenticatedRequest(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateOidc_Scope(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateOidc_SessionCookieName(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateOidc_TokenEndpoint(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateOidc_AuthorizationEndpoint(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateOidc_ClientId(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateOidc_UserInfoEndpoint(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateOidc_AuthenticationRequestExtraParams(v, ctyVal)
		EncodeAlbListener_DefaultAction_AuthenticateOidc_SessionTimeout(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
