...
package v1alpha1func EncodeS3BucketMetric(r S3BucketMetric) cty.Value {
...
func EncodeS3BucketMetric_Filter(p *Filter, vals map[string]cty.Value) {
	...
	for _, v := range p.Filter {
		...
		EncodeS3BucketMetric_Filter_Tags(v, ctyVal)
		EncodeS3BucketMetric_Filter_Prefix(v, ctyVal)
