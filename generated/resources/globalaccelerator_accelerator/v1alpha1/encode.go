...
package v1alpha1func EncodeGlobalacceleratorAccelerator(r GlobalacceleratorAccelerator) cty.Value {
...
func EncodeGlobalacceleratorAccelerator_Attributes(p *Attributes, vals map[string]cty.Value) {
	...
	for _, v := range p.Attributes {
		...
		EncodeGlobalacceleratorAccelerator_Attributes_FlowLogsEnabled(v, ctyVal)
		EncodeGlobalacceleratorAccelerator_Attributes_FlowLogsS3Bucket(v, ctyVal)
		EncodeGlobalacceleratorAccelerator_Attributes_FlowLogsS3Prefix(v, ctyVal)
