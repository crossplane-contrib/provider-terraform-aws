...
func (r *resourceMerger) MergeResources(kube resource.Managed, prov resource.Managed) plugin.MergeDescription {
	...
	updated = MergeDxHostedPublicVirtualInterfaceAccepter_Id(&k.Spec.ForProvider, &p.Spec.ForProvider, md)
	if updated {
...
func MergeDxHostedPublicVirtualInterfaceAccepter_Id(k *DxHostedPublicVirtualInterfaceAccepterParameters, p *DxHostedPublicVirtualInterfaceAccepterParameters, md *plugin.MergeDescription) bool {
	if k.Id != p.Id {
		p.Id = k.Id
