...
package v1alpha1func EncodeEksCluster(r EksCluster) cty.Value {
...
func EncodeEksCluster_EncryptionConfig(p *EncryptionConfig, vals map[string]cty.Value) {
	...
	for _, v := range p.EncryptionConfig {
		ctyVal = make(map[string]cty.Value)
		EncodeEksCluster_EncryptionConfig_Resources(v, ctyVal)
		EncodeEksCluster_EncryptionConfig_Provider(v.Provider, ctyVal)
...
func EncodeEksCluster_EncryptionConfig_Provider(p *Provider, vals map[string]cty.Value) {
	...
	for _, v := range p.Provider {
		ctyVal = make(map[string]cty.Value)
		EncodeEksCluster_EncryptionConfig_Provider_KeyArn(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeEksCluster_VpcConfig(p *VpcConfig, vals map[string]cty.Value) {
	...
	for _, v := range p.VpcConfig {
		ctyVal = make(map[string]cty.Value)
		EncodeEksCluster_VpcConfig_SecurityGroupIds(v, ctyVal)
		EncodeEksCluster_VpcConfig_SubnetIds(v, ctyVal)
		EncodeEksCluster_VpcConfig_VpcId(v, ctyVal)
		EncodeEksCluster_VpcConfig_ClusterSecurityGroupId(v, ctyVal)
		EncodeEksCluster_VpcConfig_EndpointPrivateAccess(v, ctyVal)
		EncodeEksCluster_VpcConfig_EndpointPublicAccess(v, ctyVal)
		EncodeEksCluster_VpcConfig_PublicAccessCidrs(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeEksCluster_CertificateAuthority(p *CertificateAuthority, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.CertificateAuthority {
		ctyVal = make(map[string]cty.Value)
