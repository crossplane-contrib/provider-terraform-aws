...
package v1alpha1func EncodeOpsworksMemcachedLayer(r OpsworksMemcachedLayer) cty.Value {
...
func EncodeOpsworksMemcachedLayer_AllocatedMemory(p *OpsworksMemcachedLayerParameters, vals map[string]cty.Value) {
	vals["allocated_memory"] = cty.IntVal(p.AllocatedMemory)
}
...
func EncodeOpsworksMemcachedLayer_EbsVolume(p *EbsVolume, vals map[string]cty.Value) {
	...
	for _, v := range p.EbsVolume {
		...
		EncodeOpsworksMemcachedLayer_EbsVolume_Size(v, ctyVal)
		EncodeOpsworksMemcachedLayer_EbsVolume_Type(v, ctyVal)
		EncodeOpsworksMemcachedLayer_EbsVolume_Encrypted(v, ctyVal)
		EncodeOpsworksMemcachedLayer_EbsVolume_Iops(v, ctyVal)
		EncodeOpsworksMemcachedLayer_EbsVolume_MountPoint(v, ctyVal)
		EncodeOpsworksMemcachedLayer_EbsVolume_NumberOfDisks(v, ctyVal)
		EncodeOpsworksMemcachedLayer_EbsVolume_RaidLevel(v, ctyVal)
