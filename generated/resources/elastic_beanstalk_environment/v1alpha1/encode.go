...
package v1alpha1func EncodeElasticBeanstalkEnvironment(r ElasticBeanstalkEnvironment) cty.Value {
...
func EncodeElasticBeanstalkEnvironment_Setting(p *Setting, vals map[string]cty.Value) {
	...
	for _, v := range p.Setting {
		...
		EncodeElasticBeanstalkEnvironment_Setting_Resource(v, ctyVal)
		EncodeElasticBeanstalkEnvironment_Setting_Value(v, ctyVal)
		EncodeElasticBeanstalkEnvironment_Setting_Name(v, ctyVal)
		EncodeElasticBeanstalkEnvironment_Setting_Namespace(v, ctyVal)
