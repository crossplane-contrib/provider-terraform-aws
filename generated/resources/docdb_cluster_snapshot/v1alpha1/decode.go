...
func DecodeDocdbClusterSnapshot(prev *DocdbClusterSnapshot, ctyValue cty.Value) (resource.Managed, error) {
	...
	DecodeDocdbClusterSnapshot_Id(&new.Spec.ForProvider, valMap)
...
func DecodeDocdbClusterSnapshot_Id(p *DocdbClusterSnapshotParameters, vals map[string]cty.Value) {
