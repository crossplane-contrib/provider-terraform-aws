...
func (mg *LambdaProvisionedConcurrencyConfig) GetCondition(ct runtimev1alpha1.ConditionType) runtimev1alpha1.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this LambdaProvisionedConcurrencyConfig.
func (mg *LambdaProvisionedConcurrencyConfig) GetDeletionPolicy() runtimev1alpha1.DeletionPolicy {
...
func (mg *LambdaProvisionedConcurrencyConfig) SetConditions(c ...runtimev1alpha1.Condition) {
	mg.Status.SetConditions(c...)
}

// SetDeletionPolicy of this LambdaProvisionedConcurrencyConfig.
func (mg *LambdaProvisionedConcurrencyConfig) SetDeletionPolicy(r runtimev1alpha1.DeletionPolicy) {
