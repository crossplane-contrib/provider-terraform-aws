...
func (r *resourceMerger) MergeResources(kube resource.Managed, prov resource.Managed) plugin.MergeDescription {
	...
	updated = MergeDmsReplicationInstance_Id(&k.Spec.ForProvider, &p.Spec.ForProvider, md)
	if updated {
		anyChildUpdated = true
	}
...
func MergeDmsReplicationInstance_VpcSecurityGroupIds(k *DmsReplicationInstanceParameters, p *DmsReplicationInstanceParameters, md *plugin.MergeDescription) bool {
	if !plugin.CompareStringSlices(p.VpcSecurityGroupIds, p.VpcSecurityGroupIds) {
...
//mergePrimitiveTemplateSpec
func MergeDmsReplicationInstance_Id(k *DmsReplicationInstanceParameters, p *DmsReplicationInstanceParameters, md *plugin.MergeDescription) bool {
	if k.Id != p.Id {
		p.Id = k.Id
		md.NeedsProviderUpdate = true
		return true
...
func MergeDmsReplicationInstance_ReplicationInstancePublicIps(k *DmsReplicationInstanceObservation, p *DmsReplicationInstanceObservation, md *plugin.MergeDescription) bool {
	if !plugin.CompareStringSlices(p.ReplicationInstancePublicIps, p.ReplicationInstancePublicIps) {
...
func MergeDmsReplicationInstance_ReplicationInstancePrivateIps(k *DmsReplicationInstanceObservation, p *DmsReplicationInstanceObservation, md *plugin.MergeDescription) bool {
	if !plugin.CompareStringSlices(p.ReplicationInstancePrivateIps, p.ReplicationInstancePrivateIps) {
