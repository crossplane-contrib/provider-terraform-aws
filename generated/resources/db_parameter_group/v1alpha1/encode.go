...
package v1alpha1func EncodeDbParameterGroup(r DbParameterGroup) cty.Value {
...
func EncodeDbParameterGroup_Parameter(p *Parameter, vals map[string]cty.Value) {
	...
	for _, v := range p.Parameter {
		...
		EncodeDbParameterGroup_Parameter_ApplyMethod(v, ctyVal)
		EncodeDbParameterGroup_Parameter_Name(v, ctyVal)
		EncodeDbParameterGroup_Parameter_Value(v, ctyVal)
