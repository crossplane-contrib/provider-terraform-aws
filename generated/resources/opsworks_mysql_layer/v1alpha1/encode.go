...
package v1alpha1func EncodeOpsworksMysqlLayer(r OpsworksMysqlLayer) cty.Value {
...
func EncodeOpsworksMysqlLayer_EbsVolume(p *EbsVolume, vals map[string]cty.Value) {
	...
	for _, v := range p.EbsVolume {
		...
		EncodeOpsworksMysqlLayer_EbsVolume_Size(v, ctyVal)
		EncodeOpsworksMysqlLayer_EbsVolume_Type(v, ctyVal)
		EncodeOpsworksMysqlLayer_EbsVolume_Encrypted(v, ctyVal)
		EncodeOpsworksMysqlLayer_EbsVolume_Iops(v, ctyVal)
		EncodeOpsworksMysqlLayer_EbsVolume_MountPoint(v, ctyVal)
		EncodeOpsworksMysqlLayer_EbsVolume_NumberOfDisks(v, ctyVal)
		EncodeOpsworksMysqlLayer_EbsVolume_RaidLevel(v, ctyVal)
