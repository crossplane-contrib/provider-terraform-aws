...
package v1alpha1func EncodeEcsTaskDefinition(r EcsTaskDefinition) cty.Value {
...
func EncodeEcsTaskDefinition_InferenceAccelerator(p *InferenceAccelerator, vals map[string]cty.Value) {
	...
	for _, v := range p.InferenceAccelerator {
		ctyVal = make(map[string]cty.Value)
		EncodeEcsTaskDefinition_InferenceAccelerator_DeviceType(v, ctyVal)
		EncodeEcsTaskDefinition_InferenceAccelerator_DeviceName(v, ctyVal)
...
func EncodeEcsTaskDefinition_PlacementConstraints(p *PlacementConstraints, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.PlacementConstraints {
		ctyVal = make(map[string]cty.Value)
...
func EncodeEcsTaskDefinition_ProxyConfiguration(p *ProxyConfiguration, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.ProxyConfiguration {
		ctyVal = make(map[string]cty.Value)
		EncodeEcsTaskDefinition_ProxyConfiguration_ContainerName(v, ctyVal)
		EncodeEcsTaskDefinition_ProxyConfiguration_Properties(v, ctyVal)
		EncodeEcsTaskDefinition_ProxyConfiguration_Type(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeEcsTaskDefinition_Volume(p *Volume, vals map[string]cty.Value) {
	...
	for _, v := range p.Volume {
		ctyVal = make(map[string]cty.Value)
		EncodeEcsTaskDefinition_Volume_HostPath(v, ctyVal)
		EncodeEcsTaskDefinition_Volume_Name(v, ctyVal)
		EncodeEcsTaskDefinition_Volume_DockerVolumeConfiguration(v.DockerVolumeConfiguration, ctyVal)
		EncodeEcsTaskDefinition_Volume_EfsVolumeConfiguration(v.EfsVolumeConfiguration, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeEcsTaskDefinition_Volume_DockerVolumeConfiguration(p *DockerVolumeConfiguration, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.DockerVolumeConfiguration {
		ctyVal = make(map[string]cty.Value)
		EncodeEcsTaskDefinition_Volume_DockerVolumeConfiguration_Autoprovision(v, ctyVal)
		EncodeEcsTaskDefinition_Volume_DockerVolumeConfiguration_Driver(v, ctyVal)
		EncodeEcsTaskDefinition_Volume_DockerVolumeConfiguration_DriverOpts(v, ctyVal)
		EncodeEcsTaskDefinition_Volume_DockerVolumeConfiguration_Labels(v, ctyVal)
		EncodeEcsTaskDefinition_Volume_DockerVolumeConfiguration_Scope(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeEcsTaskDefinition_Volume_EfsVolumeConfiguration(p *EfsVolumeConfiguration, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.EfsVolumeConfiguration {
		ctyVal = make(map[string]cty.Value)
		EncodeEcsTaskDefinition_Volume_EfsVolumeConfiguration_RootDirectory(v, ctyVal)
		EncodeEcsTaskDefinition_Volume_EfsVolumeConfiguration_TransitEncryption(v, ctyVal)
		EncodeEcsTaskDefinition_Volume_EfsVolumeConfiguration_TransitEncryptionPort(v, ctyVal)
		EncodeEcsTaskDefinition_Volume_EfsVolumeConfiguration_FileSystemId(v, ctyVal)
		EncodeEcsTaskDefinition_Volume_EfsVolumeConfiguration_AuthorizationConfig(v.AuthorizationConfig, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeEcsTaskDefinition_Volume_EfsVolumeConfiguration_TransitEncryptionPort(p *EfsVolumeConfiguration, vals map[string]cty.Value) {
	vals["transit_encryption_port"] = cty.IntVal(p.TransitEncryptionPort)
}
...
func EncodeEcsTaskDefinition_Volume_EfsVolumeConfiguration_AuthorizationConfig(p *AuthorizationConfig, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.AuthorizationConfig {
		ctyVal = make(map[string]cty.Value)
		EncodeEcsTaskDefinition_Volume_EfsVolumeConfiguration_AuthorizationConfig_AccessPointId(v, ctyVal)
		EncodeEcsTaskDefinition_Volume_EfsVolumeConfiguration_AuthorizationConfig_Iam(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
