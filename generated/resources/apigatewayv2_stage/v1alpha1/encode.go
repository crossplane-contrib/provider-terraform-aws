...
package v1alpha1func EncodeApigatewayv2Stage(r Apigatewayv2Stage) cty.Value {
...
func EncodeApigatewayv2Stage_AccessLogSettings(p *AccessLogSettings, vals map[string]cty.Value) {
	...
	for _, v := range p.AccessLogSettings {
		...
		EncodeApigatewayv2Stage_AccessLogSettings_DestinationArn(v, ctyVal)
		EncodeApigatewayv2Stage_AccessLogSettings_Format(v, ctyVal)
...
func EncodeApigatewayv2Stage_DefaultRouteSettings(p *DefaultRouteSettings, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.DefaultRouteSettings {
		ctyVal = make(map[string]cty.Value)
		EncodeApigatewayv2Stage_DefaultRouteSettings_DataTraceEnabled(v, ctyVal)
		EncodeApigatewayv2Stage_DefaultRouteSettings_DetailedMetricsEnabled(v, ctyVal)
		EncodeApigatewayv2Stage_DefaultRouteSettings_LoggingLevel(v, ctyVal)
		EncodeApigatewayv2Stage_DefaultRouteSettings_ThrottlingBurstLimit(v, ctyVal)
		EncodeApigatewayv2Stage_DefaultRouteSettings_ThrottlingRateLimit(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeApigatewayv2Stage_RouteSettings(p *RouteSettings, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.RouteSettings {
		ctyVal = make(map[string]cty.Value)
		EncodeApigatewayv2Stage_RouteSettings_DataTraceEnabled(v, ctyVal)
		EncodeApigatewayv2Stage_RouteSettings_DetailedMetricsEnabled(v, ctyVal)
		EncodeApigatewayv2Stage_RouteSettings_LoggingLevel(v, ctyVal)
		EncodeApigatewayv2Stage_RouteSettings_RouteKey(v, ctyVal)
		EncodeApigatewayv2Stage_RouteSettings_ThrottlingBurstLimit(v, ctyVal)
		EncodeApigatewayv2Stage_RouteSettings_ThrottlingRateLimit(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
