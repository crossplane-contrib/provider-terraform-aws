...
func (mg *CloudwatchLogSubscriptionFilter) GetCondition(ct runtimev1alpha1.ConditionType) runtimev1alpha1.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this CloudwatchLogSubscriptionFilter.
func (mg *CloudwatchLogSubscriptionFilter) GetDeletionPolicy() runtimev1alpha1.DeletionPolicy {
...
func (mg *CloudwatchLogSubscriptionFilter) SetConditions(c ...runtimev1alpha1.Condition) {
	mg.Status.SetConditions(c...)
}

// SetDeletionPolicy of this CloudwatchLogSubscriptionFilter.
func (mg *CloudwatchLogSubscriptionFilter) SetDeletionPolicy(r runtimev1alpha1.DeletionPolicy) {
