...
func (e *ctyEncoder) EncodeCty(mr resource.Managed, schema *providers.Schema) (cty.Value, error) {
	r, ok := mr.(*SpotInstanceRequest)
	if !ok {
		return cty.NilVal, fmt.Errorf("EncodeType received a resource.Managed value which is not a SpotInstanceRequest.")
	}
	return EncodeSpotInstanceRequest(*r), nil
}
