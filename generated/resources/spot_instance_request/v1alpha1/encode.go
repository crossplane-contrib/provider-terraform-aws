...
package v1alpha1func EncodeSpotInstanceRequest(r SpotInstanceRequest) cty.Value {
...
func EncodeSpotInstanceRequest_NetworkInterface(p *NetworkInterface, vals map[string]cty.Value) {
	...
	for _, v := range p.NetworkInterface {
		...
		EncodeSpotInstanceRequest_NetworkInterface_DeleteOnTermination(v, ctyVal)
		EncodeSpotInstanceRequest_NetworkInterface_DeviceIndex(v, ctyVal)
		EncodeSpotInstanceRequest_NetworkInterface_NetworkInterfaceId(v, ctyVal)
...
func EncodeSpotInstanceRequest_RootBlockDevice(p *RootBlockDevice, vals map[string]cty.Value) {
	...
	for _, v := range p.RootBlockDevice {
		ctyVal = make(map[string]cty.Value)
		EncodeSpotInstanceRequest_RootBlockDevice_VolumeId(v, ctyVal)
		EncodeSpotInstanceRequest_RootBlockDevice_VolumeSize(v, ctyVal)
		EncodeSpotInstanceRequest_RootBlockDevice_VolumeType(v, ctyVal)
		EncodeSpotInstanceRequest_RootBlockDevice_DeleteOnTermination(v, ctyVal)
		EncodeSpotInstanceRequest_RootBlockDevice_DeviceName(v, ctyVal)
		EncodeSpotInstanceRequest_RootBlockDevice_Encrypted(v, ctyVal)
		EncodeSpotInstanceRequest_RootBlockDevice_Iops(v, ctyVal)
		EncodeSpotInstanceRequest_RootBlockDevice_KmsKeyId(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeSpotInstanceRequest_CreditSpecification(p *CreditSpecification, vals map[string]cty.Value) {
	...
	for _, v := range p.CreditSpecification {
		ctyVal = make(map[string]cty.Value)
		EncodeSpotInstanceRequest_CreditSpecification_CpuCredits(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeSpotInstanceRequest_EbsBlockDevice(p *EbsBlockDevice, vals map[string]cty.Value) {
	...
	for _, v := range p.EbsBlockDevice {
		ctyVal = make(map[string]cty.Value)
		EncodeSpotInstanceRequest_EbsBlockDevice_VolumeType(v, ctyVal)
		EncodeSpotInstanceRequest_EbsBlockDevice_DeviceName(v, ctyVal)
		EncodeSpotInstanceRequest_EbsBlockDevice_Iops(v, ctyVal)
		EncodeSpotInstanceRequest_EbsBlockDevice_KmsKeyId(v, ctyVal)
		EncodeSpotInstanceRequest_EbsBlockDevice_VolumeId(v, ctyVal)
		EncodeSpotInstanceRequest_EbsBlockDevice_DeleteOnTermination(v, ctyVal)
		EncodeSpotInstanceRequest_EbsBlockDevice_Encrypted(v, ctyVal)
		EncodeSpotInstanceRequest_EbsBlockDevice_SnapshotId(v, ctyVal)
		EncodeSpotInstanceRequest_EbsBlockDevice_VolumeSize(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeSpotInstanceRequest_EphemeralBlockDevice(p *EphemeralBlockDevice, vals map[string]cty.Value) {
	...
	for _, v := range p.EphemeralBlockDevice {
		ctyVal = make(map[string]cty.Value)
		EncodeSpotInstanceRequest_EphemeralBlockDevice_VirtualName(v, ctyVal)
		EncodeSpotInstanceRequest_EphemeralBlockDevice_DeviceName(v, ctyVal)
		EncodeSpotInstanceRequest_EphemeralBlockDevice_NoDevice(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeSpotInstanceRequest_MetadataOptions(p *MetadataOptions, vals map[string]cty.Value) {
	...
	for _, v := range p.MetadataOptions {
		ctyVal = make(map[string]cty.Value)
		EncodeSpotInstanceRequest_MetadataOptions_HttpEndpoint(v, ctyVal)
		EncodeSpotInstanceRequest_MetadataOptions_HttpPutResponseHopLimit(v, ctyVal)
		EncodeSpotInstanceRequest_MetadataOptions_HttpTokens(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
