...
func (mg *DxHostedTransitVirtualInterfaceAccepter) GetCondition(ct runtimev1alpha1.ConditionType) runtimev1alpha1.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this DxHostedTransitVirtualInterfaceAccepter.
func (mg *DxHostedTransitVirtualInterfaceAccepter) GetDeletionPolicy() runtimev1alpha1.DeletionPolicy {
...
*/
func (mg *DxHostedTransitVirtualInterfaceAccepter) GetProviderReference() *runtimev1alpha1.Reference {
...
func (mg *DxHostedTransitVirtualInterfaceAccepter) SetConditions(c ...runtimev1alpha1.Condition) {
	mg.Status.SetConditions(c...)
}

// SetDeletionPolicy of this DxHostedTransitVirtualInterfaceAccepter.
func (mg *DxHostedTransitVirtualInterfaceAccepter) SetDeletionPolicy(r runtimev1alpha1.DeletionPolicy) {
...
*/
func (mg *DxHostedTransitVirtualInterfaceAccepter) SetProviderReference(r *runtimev1alpha1.Reference) {
