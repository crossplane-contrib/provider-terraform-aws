...
package v1alpha1func EncodeElasticacheReplicationGroup(r ElasticacheReplicationGroup) cty.Value {
...
func EncodeElasticacheReplicationGroup_NumberCacheClusters(p *ElasticacheReplicationGroupParameters, vals map[string]cty.Value) {
	vals["number_cache_clusters"] = cty.IntVal(p.NumberCacheClusters)
}
...
func EncodeElasticacheReplicationGroup_ClusterMode(p *ClusterMode, vals map[string]cty.Value) {
	...
	for _, v := range p.ClusterMode {
		ctyVal = make(map[string]cty.Value)
		EncodeElasticacheReplicationGroup_ClusterMode_NumNodeGroups(v, ctyVal)
		EncodeElasticacheReplicationGroup_ClusterMode_ReplicasPerNodeGroup(v, ctyVal)
