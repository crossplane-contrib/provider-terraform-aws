...
package v1alpha1func EncodeSecretsmanagerSecretRotation(r SecretsmanagerSecretRotation) cty.Value {
...
func EncodeSecretsmanagerSecretRotation_RotationRules(p *RotationRules, vals map[string]cty.Value) {
	...
	for _, v := range p.RotationRules {
		...
		EncodeSecretsmanagerSecretRotation_RotationRules_AutomaticallyAfterDays(v, ctyVal)
