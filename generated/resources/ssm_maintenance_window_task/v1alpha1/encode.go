...
func EncodeSsmMaintenanceWindowTask(r SsmMaintenanceWindowTask) cty.Value {
...
func EncodeSsmMaintenanceWindowTask_TaskInvocationParameters(p TaskInvocationParameters, vals map[string]cty.Value) {
	...
	ctyVal := make(map[string]cty.Value)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_StepFunctionsParameters(p.StepFunctionsParameters, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_AutomationParameters(p.AutomationParameters, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_LambdaParameters(p.LambdaParameters, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters(p.RunCommandParameters, ctyVal)
...
func EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_StepFunctionsParameters(p StepFunctionsParameters, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_StepFunctionsParameters_Input(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_StepFunctionsParameters_Name(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_AutomationParameters(p AutomationParameters, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_AutomationParameters_DocumentVersion(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_AutomationParameters_Parameter(p.Parameter, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_AutomationParameters_Parameter(p Parameter, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_AutomationParameters_Parameter_Name(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_AutomationParameters_Parameter_Values(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_LambdaParameters(p LambdaParameters, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_LambdaParameters_ClientContext(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_LambdaParameters_Payload(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_LambdaParameters_Qualifier(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters(p RunCommandParameters, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_TimeoutSeconds(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_Comment(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_DocumentHash(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_DocumentHashType(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_OutputS3Bucket(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_OutputS3KeyPrefix(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_ServiceRoleArn(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_NotificationConfig(p.NotificationConfig, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_Parameter(p.Parameter, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_TimeoutSeconds(p RunCommandParameters, vals map[string]cty.Value) {
	vals["timeout_seconds"] = cty.NumberIntVal(p.TimeoutSeconds)
}
...
func EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_NotificationConfig(p NotificationConfig, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_NotificationConfig_NotificationArn(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_NotificationConfig_NotificationEvents(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_NotificationConfig_NotificationType(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_Parameter(p Parameter, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_Parameter_Name(p, ctyVal)
	EncodeSsmMaintenanceWindowTask_TaskInvocationParameters_RunCommandParameters_Parameter_Values(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
	vals["parameter"] = cty.SetVal(valsForCollection)
}
