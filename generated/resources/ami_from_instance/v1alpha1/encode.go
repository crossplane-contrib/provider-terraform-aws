...
package v1alpha1func EncodeAmiFromInstance(r AmiFromInstance) cty.Value {
...
func EncodeAmiFromInstance_EbsBlockDevice(p *EbsBlockDevice, vals map[string]cty.Value) {
	...
	for _, v := range p.EbsBlockDevice {
		...
		EncodeAmiFromInstance_EbsBlockDevice_DeviceName(v, ctyVal)
		EncodeAmiFromInstance_EbsBlockDevice_Encrypted(v, ctyVal)
		EncodeAmiFromInstance_EbsBlockDevice_Iops(v, ctyVal)
		EncodeAmiFromInstance_EbsBlockDevice_SnapshotId(v, ctyVal)
		EncodeAmiFromInstance_EbsBlockDevice_VolumeSize(v, ctyVal)
		EncodeAmiFromInstance_EbsBlockDevice_VolumeType(v, ctyVal)
		EncodeAmiFromInstance_EbsBlockDevice_DeleteOnTermination(v, ctyVal)
...
func EncodeAmiFromInstance_EphemeralBlockDevice(p *EphemeralBlockDevice, vals map[string]cty.Value) {
	...
	for _, v := range p.EphemeralBlockDevice {
		ctyVal = make(map[string]cty.Value)
		EncodeAmiFromInstance_EphemeralBlockDevice_DeviceName(v, ctyVal)
		EncodeAmiFromInstance_EphemeralBlockDevice_VirtualName(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
