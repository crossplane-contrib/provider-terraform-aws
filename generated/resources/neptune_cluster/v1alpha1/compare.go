...
func (r *resourceMerger) MergeResources(kube resource.Managed, prov resource.Managed) plugin.MergeDescription {
	...
	updated = MergeNeptuneCluster_Id(&k.Spec.ForProvider, &p.Spec.ForProvider, md)
	if updated {
		anyChildUpdated = true
	}
...
func MergeNeptuneCluster_IamRoles(k *NeptuneClusterParameters, p *NeptuneClusterParameters, md *plugin.MergeDescription) bool {
	if !plugin.CompareStringSlices(p.IamRoles, p.IamRoles) {
...
//mergePrimitiveTemplateSpec
func MergeNeptuneCluster_Id(k *NeptuneClusterParameters, p *NeptuneClusterParameters, md *plugin.MergeDescription) bool {
	if k.Id != p.Id {
		p.Id = k.Id
		md.NeedsProviderUpdate = true
		return true
...
func MergeNeptuneCluster_EnableCloudwatchLogsExports(k *NeptuneClusterParameters, p *NeptuneClusterParameters, md *plugin.MergeDescription) bool {
	if !plugin.CompareStringSlices(p.EnableCloudwatchLogsExports, p.EnableCloudwatchLogsExports) {
...
func MergeNeptuneCluster_ClusterMembers(k *NeptuneClusterObservation, p *NeptuneClusterObservation, md *plugin.MergeDescription) bool {
	if !plugin.CompareStringSlices(p.ClusterMembers, p.ClusterMembers) {
