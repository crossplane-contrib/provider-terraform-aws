...
package v1alpha1func EncodeAthenaDatabase(r AthenaDatabase) cty.Value {
...
func EncodeAthenaDatabase_EncryptionConfiguration(p *EncryptionConfiguration, vals map[string]cty.Value) {
	...
	for _, v := range p.EncryptionConfiguration {
		...
		EncodeAthenaDatabase_EncryptionConfiguration_EncryptionOption(v, ctyVal)
		EncodeAthenaDatabase_EncryptionConfiguration_KmsKey(v, ctyVal)
