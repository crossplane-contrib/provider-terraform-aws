...
func (mg *SnapshotCreateVolumePermission) GetCondition(ct runtimev1alpha1.ConditionType) runtimev1alpha1.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this SnapshotCreateVolumePermission.
func (mg *SnapshotCreateVolumePermission) GetDeletionPolicy() runtimev1alpha1.DeletionPolicy {
...
func (mg *SnapshotCreateVolumePermission) SetConditions(c ...runtimev1alpha1.Condition) {
	mg.Status.SetConditions(c...)
}

// SetDeletionPolicy of this SnapshotCreateVolumePermission.
func (mg *SnapshotCreateVolumePermission) SetDeletionPolicy(r runtimev1alpha1.DeletionPolicy) {
