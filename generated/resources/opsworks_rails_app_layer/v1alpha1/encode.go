...
package v1alpha1func EncodeOpsworksRailsAppLayer(r OpsworksRailsAppLayer) cty.Value {
...
func EncodeOpsworksRailsAppLayer_EbsVolume(p *EbsVolume, vals map[string]cty.Value) {
	...
	for _, v := range p.EbsVolume {
		...
		EncodeOpsworksRailsAppLayer_EbsVolume_Type(v, ctyVal)
		EncodeOpsworksRailsAppLayer_EbsVolume_Encrypted(v, ctyVal)
		EncodeOpsworksRailsAppLayer_EbsVolume_Iops(v, ctyVal)
		EncodeOpsworksRailsAppLayer_EbsVolume_MountPoint(v, ctyVal)
		EncodeOpsworksRailsAppLayer_EbsVolume_NumberOfDisks(v, ctyVal)
		EncodeOpsworksRailsAppLayer_EbsVolume_RaidLevel(v, ctyVal)
		EncodeOpsworksRailsAppLayer_EbsVolume_Size(v, ctyVal)
