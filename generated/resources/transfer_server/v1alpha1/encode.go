...
package v1alpha1func EncodeTransferServer(r TransferServer) cty.Value {
...
func EncodeTransferServer_EndpointDetails(p *EndpointDetails, vals map[string]cty.Value) {
	...
	for _, v := range p.EndpointDetails {
		...
		EncodeTransferServer_EndpointDetails_AddressAllocationIds(v, ctyVal)
		EncodeTransferServer_EndpointDetails_SubnetIds(v, ctyVal)
		EncodeTransferServer_EndpointDetails_VpcEndpointId(v, ctyVal)
		EncodeTransferServer_EndpointDetails_VpcId(v, ctyVal)
