...
func (r *resourceMerger) MergeResources(kube resource.Managed, prov resource.Managed) plugin.MergeDescription {
	...
	updated = MergeVpcEndpointSubnetAssociation_Id(&k.Spec.ForProvider, &p.Spec.ForProvider, md)
	if updated {
...
func MergeVpcEndpointSubnetAssociation_Id(k *VpcEndpointSubnetAssociationParameters, p *VpcEndpointSubnetAssociationParameters, md *plugin.MergeDescription) bool {
	if k.Id != p.Id {
		p.Id = k.Id
