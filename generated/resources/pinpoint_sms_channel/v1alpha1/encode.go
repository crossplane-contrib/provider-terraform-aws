...
package v1alpha1func EncodePinpointSmsChannel(r PinpointSmsChannel) cty.Value {
...
func EncodePinpointSmsChannel_PromotionalMessagesPerSecond(p *PinpointSmsChannelObservation, vals map[string]cty.Value) {
	vals["promotional_messages_per_second"] = cty.IntVal(p.PromotionalMessagesPerSecond)
}

func EncodePinpointSmsChannel_TransactionalMessagesPerSecond(p *PinpointSmsChannelObservation, vals map[string]cty.Value) {
	vals["transactional_messages_per_second"] = cty.IntVal(p.TransactionalMessagesPerSecond)
}