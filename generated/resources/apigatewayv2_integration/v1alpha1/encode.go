...
package v1alpha1func EncodeApigatewayv2Integration(r Apigatewayv2Integration) cty.Value {
...
func EncodeApigatewayv2Integration_TlsConfig(p *TlsConfig, vals map[string]cty.Value) {
	...
	for _, v := range p.TlsConfig {
		ctyVal = make(map[string]cty.Value)
		EncodeApigatewayv2Integration_TlsConfig_ServerNameToVerify(v, ctyVal)
