...
package v1alpha1func EncodeDatasyncLocationEfs(r DatasyncLocationEfs) cty.Value {
...
func EncodeDatasyncLocationEfs_Ec2Config(p *Ec2Config, vals map[string]cty.Value) {
	...
	for _, v := range p.Ec2Config {
		ctyVal = make(map[string]cty.Value)
		EncodeDatasyncLocationEfs_Ec2Config_SecurityGroupArns(v, ctyVal)
		EncodeDatasyncLocationEfs_Ec2Config_SubnetArn(v, ctyVal)
