...
package v1alpha1func EncodeEc2Fleet(r Ec2Fleet) cty.Value {
...
func EncodeEc2Fleet_SpotOptions(p *SpotOptions, vals map[string]cty.Value) {
	...
	for _, v := range p.SpotOptions {
		...
		EncodeEc2Fleet_SpotOptions_InstanceInterruptionBehavior(v, ctyVal)
		EncodeEc2Fleet_SpotOptions_InstancePoolsToUseCount(v, ctyVal)
		EncodeEc2Fleet_SpotOptions_AllocationStrategy(v, ctyVal)
...
func EncodeEc2Fleet_TargetCapacitySpecification(p *TargetCapacitySpecification, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.TargetCapacitySpecification {
		ctyVal = make(map[string]cty.Value)
		EncodeEc2Fleet_TargetCapacitySpecification_SpotTargetCapacity(v, ctyVal)
		EncodeEc2Fleet_TargetCapacitySpecification_TotalTargetCapacity(v, ctyVal)
		EncodeEc2Fleet_TargetCapacitySpecification_DefaultTargetCapacityType(v, ctyVal)
		EncodeEc2Fleet_TargetCapacitySpecification_OnDemandTargetCapacity(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeEc2Fleet_TargetCapacitySpecification_SpotTargetCapacity(p *TargetCapacitySpecification, vals map[string]cty.Value) {
	vals["spot_target_capacity"] = cty.IntVal(p.SpotTargetCapacity)
}
...
func EncodeEc2Fleet_TargetCapacitySpecification_TotalTargetCapacity(p *TargetCapacitySpecification, vals map[string]cty.Value) {
	vals["total_target_capacity"] = cty.IntVal(p.TotalTargetCapacity)
}
...
func EncodeEc2Fleet_TargetCapacitySpecification_OnDemandTargetCapacity(p *TargetCapacitySpecification, vals map[string]cty.Value) {
	vals["on_demand_target_capacity"] = cty.IntVal(p.OnDemandTargetCapacity)
}
...
func EncodeEc2Fleet_LaunchTemplateConfig(p *LaunchTemplateConfig, vals map[string]cty.Value) {
	...
	for _, v := range p.LaunchTemplateConfig {
		ctyVal = make(map[string]cty.Value)
		EncodeEc2Fleet_LaunchTemplateConfig_LaunchTemplateSpecification(v.LaunchTemplateSpecification, ctyVal)
		EncodeEc2Fleet_LaunchTemplateConfig_Override(v.Override, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeEc2Fleet_LaunchTemplateConfig_LaunchTemplateSpecification(p *LaunchTemplateSpecification, vals map[string]cty.Value) {
	...
	for _, v := range p.LaunchTemplateSpecification {
		ctyVal = make(map[string]cty.Value)
		EncodeEc2Fleet_LaunchTemplateConfig_LaunchTemplateSpecification_LaunchTemplateId(v, ctyVal)
		EncodeEc2Fleet_LaunchTemplateConfig_LaunchTemplateSpecification_LaunchTemplateName(v, ctyVal)
		EncodeEc2Fleet_LaunchTemplateConfig_LaunchTemplateSpecification_Version(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeEc2Fleet_OnDemandOptions(p *OnDemandOptions, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.OnDemandOptions {
		ctyVal = make(map[string]cty.Value)
		EncodeEc2Fleet_OnDemandOptions_AllocationStrategy(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
