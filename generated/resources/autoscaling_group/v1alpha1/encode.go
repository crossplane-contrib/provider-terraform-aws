...
func EncodeAutoscalingGroup(r AutoscalingGroup) cty.Value {
...
func EncodeAutoscalingGroup_MinElbCapacity(p AutoscalingGroupParameters, vals map[string]cty.Value) {
	vals["min_elb_capacity"] = cty.NumberIntVal(p.MinElbCapacity)
}
...
func EncodeAutoscalingGroup_WaitForElbCapacity(p AutoscalingGroupParameters, vals map[string]cty.Value) {
	vals["wait_for_elb_capacity"] = cty.NumberIntVal(p.WaitForElbCapacity)
}
...
func EncodeAutoscalingGroup_HealthCheckGracePeriod(p AutoscalingGroupParameters, vals map[string]cty.Value) {
	vals["health_check_grace_period"] = cty.NumberIntVal(p.HealthCheckGracePeriod)
}
...
func EncodeAutoscalingGroup_DefaultCooldown(p AutoscalingGroupParameters, vals map[string]cty.Value) {
	vals["default_cooldown"] = cty.NumberIntVal(p.DefaultCooldown)
}

func EncodeAutoscalingGroup_MaxInstanceLifetime(p AutoscalingGroupParameters, vals map[string]cty.Value) {
	vals["max_instance_lifetime"] = cty.NumberIntVal(p.MaxInstanceLifetime)
}
...
func EncodeAutoscalingGroup_InitialLifecycleHook(p InitialLifecycleHook, vals map[string]cty.Value) {
	...
	ctyVal := make(map[string]cty.Value)
	EncodeAutoscalingGroup_InitialLifecycleHook_NotificationMetadata(p, ctyVal)
	EncodeAutoscalingGroup_InitialLifecycleHook_NotificationTargetArn(p, ctyVal)
	EncodeAutoscalingGroup_InitialLifecycleHook_RoleArn(p, ctyVal)
	EncodeAutoscalingGroup_InitialLifecycleHook_DefaultResult(p, ctyVal)
	EncodeAutoscalingGroup_InitialLifecycleHook_HeartbeatTimeout(p, ctyVal)
	EncodeAutoscalingGroup_InitialLifecycleHook_LifecycleTransition(p, ctyVal)
	EncodeAutoscalingGroup_InitialLifecycleHook_Name(p, ctyVal)
...
func EncodeAutoscalingGroup_LaunchTemplate(p LaunchTemplate, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeAutoscalingGroup_LaunchTemplate_Id(p, ctyVal)
	EncodeAutoscalingGroup_LaunchTemplate_Name(p, ctyVal)
	EncodeAutoscalingGroup_LaunchTemplate_Version(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeAutoscalingGroup_MixedInstancesPolicy(p MixedInstancesPolicy, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeAutoscalingGroup_MixedInstancesPolicy_InstancesDistribution(p.InstancesDistribution, ctyVal)
	EncodeAutoscalingGroup_MixedInstancesPolicy_LaunchTemplate(p.LaunchTemplate, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeAutoscalingGroup_MixedInstancesPolicy_InstancesDistribution(p InstancesDistribution, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeAutoscalingGroup_MixedInstancesPolicy_InstancesDistribution_OnDemandPercentageAboveBaseCapacity(p, ctyVal)
	EncodeAutoscalingGroup_MixedInstancesPolicy_InstancesDistribution_SpotAllocationStrategy(p, ctyVal)
	EncodeAutoscalingGroup_MixedInstancesPolicy_InstancesDistribution_SpotInstancePools(p, ctyVal)
	EncodeAutoscalingGroup_MixedInstancesPolicy_InstancesDistribution_SpotMaxPrice(p, ctyVal)
	EncodeAutoscalingGroup_MixedInstancesPolicy_InstancesDistribution_OnDemandAllocationStrategy(p, ctyVal)
	EncodeAutoscalingGroup_MixedInstancesPolicy_InstancesDistribution_OnDemandBaseCapacity(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeAutoscalingGroup_MixedInstancesPolicy_InstancesDistribution_OnDemandPercentageAboveBaseCapacity(p InstancesDistribution, vals map[string]cty.Value) {
	vals["on_demand_percentage_above_base_capacity"] = cty.NumberIntVal(p.OnDemandPercentageAboveBaseCapacity)
}
...
func EncodeAutoscalingGroup_MixedInstancesPolicy_InstancesDistribution_SpotInstancePools(p InstancesDistribution, vals map[string]cty.Value) {
	vals["spot_instance_pools"] = cty.NumberIntVal(p.SpotInstancePools)
}
...
func EncodeAutoscalingGroup_MixedInstancesPolicy_InstancesDistribution_OnDemandBaseCapacity(p InstancesDistribution, vals map[string]cty.Value) {
	vals["on_demand_base_capacity"] = cty.NumberIntVal(p.OnDemandBaseCapacity)
}

func EncodeAutoscalingGroup_MixedInstancesPolicy_LaunchTemplate(p LaunchTemplate, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeAutoscalingGroup_MixedInstancesPolicy_LaunchTemplate_LaunchTemplateSpecification(p.LaunchTemplateSpecification, ctyVal)
	EncodeAutoscalingGroup_MixedInstancesPolicy_LaunchTemplate_Override(p.Override, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
	vals["launch_template"] = cty.ListVal(valsForCollection)
}
...
func EncodeAutoscalingGroup_MixedInstancesPolicy_LaunchTemplate_LaunchTemplateSpecification(p LaunchTemplateSpecification, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeAutoscalingGroup_MixedInstancesPolicy_LaunchTemplate_LaunchTemplateSpecification_LaunchTemplateId(p, ctyVal)
	EncodeAutoscalingGroup_MixedInstancesPolicy_LaunchTemplate_LaunchTemplateSpecification_LaunchTemplateName(p, ctyVal)
	EncodeAutoscalingGroup_MixedInstancesPolicy_LaunchTemplate_LaunchTemplateSpecification_Version(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeAutoscalingGroup_MixedInstancesPolicy_LaunchTemplate_Override(p Override, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeAutoscalingGroup_MixedInstancesPolicy_LaunchTemplate_Override_InstanceType(p, ctyVal)
	EncodeAutoscalingGroup_MixedInstancesPolicy_LaunchTemplate_Override_WeightedCapacity(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
...
func EncodeAutoscalingGroup_Tag(p Tag, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeAutoscalingGroup_Tag_Key(p, ctyVal)
	EncodeAutoscalingGroup_Tag_PropagateAtLaunch(p, ctyVal)
	EncodeAutoscalingGroup_Tag_Value(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
