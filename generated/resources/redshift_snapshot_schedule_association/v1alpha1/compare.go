...
func (r *resourceMerger) MergeResources(kube resource.Managed, prov resource.Managed) plugin.MergeDescription {
	k := kube.(*RedshiftSnapshotScheduleAssociation)
	p := prov.(*RedshiftSnapshotScheduleAssociation)
	md := &plugin.MergeDescription{}
	updated := false
	anyChildUpdated := false

	updated = MergeRedshiftSnapshotScheduleAssociation_Id(&k.Spec.ForProvider, &p.Spec.ForProvider, md)
	if updated {
...
func MergeRedshiftSnapshotScheduleAssociation_Id(k *RedshiftSnapshotScheduleAssociationParameters, p *RedshiftSnapshotScheduleAssociationParameters, md *plugin.MergeDescription) bool {
	if k.Id != p.Id {
		p.Id = k.Id
