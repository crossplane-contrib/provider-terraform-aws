...
func DecodeNeptuneClusterSnapshot(prev *NeptuneClusterSnapshot, ctyValue cty.Value) (resource.Managed, error) {
	...
	DecodeNeptuneClusterSnapshot_Id(&new.Spec.ForProvider, valMap)
...
//primitiveTypeDecodeTemplate
func DecodeNeptuneClusterSnapshot_Id(p *NeptuneClusterSnapshotParameters, vals map[string]cty.Value) {
