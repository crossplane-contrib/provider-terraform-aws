...
package v1alpha1func EncodeAcmpcaCertificateAuthority(r AcmpcaCertificateAuthority) cty.Value {
...
func EncodeAcmpcaCertificateAuthority_PermanentDeletionTimeInDays(p *AcmpcaCertificateAuthorityParameters, vals map[string]cty.Value) {
	vals["permanent_deletion_time_in_days"] = cty.IntVal(p.PermanentDeletionTimeInDays)
}
...
func EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration(p *CertificateAuthorityConfiguration, vals map[string]cty.Value) {
	...
	for _, v := range p.CertificateAuthorityConfiguration {
		ctyVal = make(map[string]cty.Value)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_KeyAlgorithm(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_SigningAlgorithm(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject(v.Subject, ctyVal)
...
func EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject(p *Subject, vals map[string]cty.Value) {
	...
	for _, v := range p.Subject {
		ctyVal = make(map[string]cty.Value)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_Pseudonym(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_Surname(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_CommonName(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_Country(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_Locality(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_OrganizationalUnit(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_Organization(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_State(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_Title(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_DistinguishedNameQualifier(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_GenerationQualifier(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_GivenName(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_CertificateAuthorityConfiguration_Subject_Initials(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeAcmpcaCertificateAuthority_RevocationConfiguration(p *RevocationConfiguration, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.RevocationConfiguration {
		ctyVal = make(map[string]cty.Value)
		EncodeAcmpcaCertificateAuthority_RevocationConfiguration_CrlConfiguration(v.CrlConfiguration, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeAcmpcaCertificateAuthority_RevocationConfiguration_CrlConfiguration(p *CrlConfiguration, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.CrlConfiguration {
		ctyVal = make(map[string]cty.Value)
		EncodeAcmpcaCertificateAuthority_RevocationConfiguration_CrlConfiguration_CustomCname(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_RevocationConfiguration_CrlConfiguration_Enabled(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_RevocationConfiguration_CrlConfiguration_ExpirationInDays(v, ctyVal)
		EncodeAcmpcaCertificateAuthority_RevocationConfiguration_CrlConfiguration_S3BucketName(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeAcmpcaCertificateAuthority_RevocationConfiguration_CrlConfiguration_ExpirationInDays(p *CrlConfiguration, vals map[string]cty.Value) {
	vals["expiration_in_days"] = cty.IntVal(p.ExpirationInDays)
}
