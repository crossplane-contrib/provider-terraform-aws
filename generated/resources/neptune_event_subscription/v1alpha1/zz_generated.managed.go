...
func (mg *NeptuneEventSubscription) GetCondition(ct runtimev1alpha1.ConditionType) runtimev1alpha1.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this NeptuneEventSubscription.
func (mg *NeptuneEventSubscription) GetDeletionPolicy() runtimev1alpha1.DeletionPolicy {
