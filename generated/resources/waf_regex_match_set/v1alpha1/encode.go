...
package v1alpha1func EncodeWafRegexMatchSet(r WafRegexMatchSet) cty.Value {
...
func EncodeWafRegexMatchSet_RegexMatchTuple(p *RegexMatchTuple, vals map[string]cty.Value) {
	...
	for _, v := range p.RegexMatchTuple {
		...
		EncodeWafRegexMatchSet_RegexMatchTuple_RegexPatternSetId(v, ctyVal)
		EncodeWafRegexMatchSet_RegexMatchTuple_TextTransformation(v, ctyVal)
		EncodeWafRegexMatchSet_RegexMatchTuple_FieldToMatch(v.FieldToMatch, ctyVal)
...
func EncodeWafRegexMatchSet_RegexMatchTuple_FieldToMatch(p *FieldToMatch, vals map[string]cty.Value) {
	...
	for _, v := range p.FieldToMatch {
		ctyVal = make(map[string]cty.Value)
		EncodeWafRegexMatchSet_RegexMatchTuple_FieldToMatch_Data(v, ctyVal)
		EncodeWafRegexMatchSet_RegexMatchTuple_FieldToMatch_Type(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
