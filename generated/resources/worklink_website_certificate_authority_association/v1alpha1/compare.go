...
func (r *resourceMerger) MergeResources(kube resource.Managed, prov resource.Managed) plugin.MergeDescription {
	k := kube.(*WorklinkWebsiteCertificateAuthorityAssociation)
	p := prov.(*WorklinkWebsiteCertificateAuthorityAssociation)
	...
	updated = MergeWorklinkWebsiteCertificateAuthorityAssociation_WebsiteCaId(&k.Status.AtProvider, &p.Status.AtProvider, md)
	if updated {
		anyChildUpdated = true
	}
...
func MergeWorklinkWebsiteCertificateAuthorityAssociation_WebsiteCaId(k *WorklinkWebsiteCertificateAuthorityAssociationObservation, p *WorklinkWebsiteCertificateAuthorityAssociationObservation, md *plugin.MergeDescription) bool {
	if k.WebsiteCaId != p.WebsiteCaId {
		k.WebsiteCaId = p.WebsiteCaId
