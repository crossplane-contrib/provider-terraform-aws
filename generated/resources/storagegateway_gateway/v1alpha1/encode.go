...
package v1alpha1func EncodeStoragegatewayGateway(r StoragegatewayGateway) cty.Value {
...
func EncodeStoragegatewayGateway_AverageDownloadRateLimitInBitsPerSec(p *StoragegatewayGatewayParameters, vals map[string]cty.Value) {
	vals["average_download_rate_limit_in_bits_per_sec"] = cty.IntVal(p.AverageDownloadRateLimitInBitsPerSec)
}
...
func EncodeStoragegatewayGateway_AverageUploadRateLimitInBitsPerSec(p *StoragegatewayGatewayParameters, vals map[string]cty.Value) {
	vals["average_upload_rate_limit_in_bits_per_sec"] = cty.IntVal(p.AverageUploadRateLimitInBitsPerSec)
}
...
func EncodeStoragegatewayGateway_SmbActiveDirectorySettings(p *SmbActiveDirectorySettings, vals map[string]cty.Value) {
	...
	for _, v := range p.SmbActiveDirectorySettings {
		ctyVal = make(map[string]cty.Value)
		EncodeStoragegatewayGateway_SmbActiveDirectorySettings_DomainName(v, ctyVal)
		EncodeStoragegatewayGateway_SmbActiveDirectorySettings_Password(v, ctyVal)
		EncodeStoragegatewayGateway_SmbActiveDirectorySettings_Username(v, ctyVal)
