...
package v1alpha1func EncodeDatasyncLocationS3(r DatasyncLocationS3) cty.Value {
...
func EncodeDatasyncLocationS3_S3Config(p *S3Config, vals map[string]cty.Value) {
	...
	for _, v := range p.S3Config {
		ctyVal = make(map[string]cty.Value)
		EncodeDatasyncLocationS3_S3Config_BucketAccessRoleArn(v, ctyVal)
