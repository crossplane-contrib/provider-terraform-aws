...
package v1alpha1func EncodeBatchComputeEnvironment(r BatchComputeEnvironment) cty.Value {
...
func EncodeBatchComputeEnvironment_ComputeResources(p *ComputeResources, vals map[string]cty.Value) {
	...
	for _, v := range p.ComputeResources {
		ctyVal = make(map[string]cty.Value)
		EncodeBatchComputeEnvironment_ComputeResources_InstanceRole(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_DesiredVcpus(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_ImageId(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_Ec2KeyPair(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_InstanceType(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_AllocationStrategy(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_BidPercentage(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_SecurityGroupIds(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_Tags(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_SpotIamFleetRole(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_Subnets(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_Type(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_MaxVcpus(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_MinVcpus(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_LaunchTemplate(v.LaunchTemplate, ctyVal)
...
func EncodeBatchComputeEnvironment_ComputeResources_DesiredVcpus(p *ComputeResources, vals map[string]cty.Value) {
	vals["desired_vcpus"] = cty.IntVal(p.DesiredVcpus)
}
...
func EncodeBatchComputeEnvironment_ComputeResources_BidPercentage(p *ComputeResources, vals map[string]cty.Value) {
	vals["bid_percentage"] = cty.IntVal(p.BidPercentage)
}
...
func EncodeBatchComputeEnvironment_ComputeResources_LaunchTemplate(p *LaunchTemplate, vals map[string]cty.Value) {
	...
	for _, v := range p.LaunchTemplate {
		ctyVal = make(map[string]cty.Value)
		EncodeBatchComputeEnvironment_ComputeResources_LaunchTemplate_LaunchTemplateId(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_LaunchTemplate_LaunchTemplateName(v, ctyVal)
		EncodeBatchComputeEnvironment_ComputeResources_LaunchTemplate_Version(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
