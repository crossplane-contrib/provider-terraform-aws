...
func (r *resourceMerger) MergeResources(kube resource.Managed, prov resource.Managed) plugin.MergeDescription {
	...
	updated = MergeDocdbCluster_Id(&k.Spec.ForProvider, &p.Spec.ForProvider, md)
	if updated {
		anyChildUpdated = true
	}
...
//mergePrimitiveTemplateSpec
func MergeDocdbCluster_Id(k *DocdbClusterParameters, p *DocdbClusterParameters, md *plugin.MergeDescription) bool {
	if k.Id != p.Id {
		p.Id = k.Id
		md.NeedsProviderUpdate = true
		return true
...
func MergeDocdbCluster_EnabledCloudwatchLogsExports(k *DocdbClusterParameters, p *DocdbClusterParameters, md *plugin.MergeDescription) bool {
	if !plugin.CompareStringSlices(p.EnabledCloudwatchLogsExports, p.EnabledCloudwatchLogsExports) {
