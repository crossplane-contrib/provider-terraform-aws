...
func (r *resourceMerger) MergeResources(kube resource.Managed, prov resource.Managed) plugin.MergeDescription {
	...
	updated = MergeIamUserPolicyAttachment_Id(&k.Spec.ForProvider, &p.Spec.ForProvider, md)
	if updated {
...
func MergeIamUserPolicyAttachment_Id(k *IamUserPolicyAttachmentParameters, p *IamUserPolicyAttachmentParameters, md *plugin.MergeDescription) bool {
	if k.Id != p.Id {
		p.Id = k.Id
