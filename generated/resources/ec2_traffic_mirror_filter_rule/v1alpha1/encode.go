...
func EncodeEc2TrafficMirrorFilterRule_DestinationPortRange(p DestinationPortRange, vals map[string]cty.Value) {
	...
	ctyVal := make(map[string]cty.Value)
	EncodeEc2TrafficMirrorFilterRule_DestinationPortRange_FromPort(p, ctyVal)
	EncodeEc2TrafficMirrorFilterRule_DestinationPortRange_ToPort(p, ctyVal)
...
func EncodeEc2TrafficMirrorFilterRule_SourcePortRange(p SourcePortRange, vals map[string]cty.Value) {
	valsForCollection := make([]cty.Value, 1)
	ctyVal := make(map[string]cty.Value)
	EncodeEc2TrafficMirrorFilterRule_SourcePortRange_FromPort(p, ctyVal)
	EncodeEc2TrafficMirrorFilterRule_SourcePortRange_ToPort(p, ctyVal)
	valsForCollection[0] = cty.ObjectVal(ctyVal)
