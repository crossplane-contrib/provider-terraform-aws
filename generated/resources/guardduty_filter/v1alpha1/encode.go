...
package v1alpha1func EncodeGuarddutyFilter(r GuarddutyFilter) cty.Value {
...
func EncodeGuarddutyFilter_FindingCriteria(p *FindingCriteria, vals map[string]cty.Value) {
	...
	for _, v := range p.FindingCriteria {
		ctyVal = make(map[string]cty.Value)
		EncodeGuarddutyFilter_FindingCriteria_Criterion(v.Criterion, ctyVal)
