...
func (r *resourceMerger) MergeResources(kube resource.Managed, prov resource.Managed) plugin.MergeDescription {
	k := kube.(*ServiceDiscoveryHttpNamespace)
	p := prov.(*ServiceDiscoveryHttpNamespace)
	...
	updated = MergeServiceDiscoveryHttpNamespace_Arn(&k.Status.AtProvider, &p.Status.AtProvider, md)
	if updated {
		anyChildUpdated = true
	}
