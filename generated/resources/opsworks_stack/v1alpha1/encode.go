...
package v1alpha1func EncodeOpsworksStack(r OpsworksStack) cty.Value {
...
func EncodeOpsworksStack_CustomCookbooksSource(p *CustomCookbooksSource, vals map[string]cty.Value) {
	...
	for _, v := range p.CustomCookbooksSource {
		ctyVal = make(map[string]cty.Value)
		EncodeOpsworksStack_CustomCookbooksSource_Password(v, ctyVal)
		EncodeOpsworksStack_CustomCookbooksSource_Revision(v, ctyVal)
		EncodeOpsworksStack_CustomCookbooksSource_SshKey(v, ctyVal)
		EncodeOpsworksStack_CustomCookbooksSource_Type(v, ctyVal)
		EncodeOpsworksStack_CustomCookbooksSource_Url(v, ctyVal)
		EncodeOpsworksStack_CustomCookbooksSource_Username(v, ctyVal)
