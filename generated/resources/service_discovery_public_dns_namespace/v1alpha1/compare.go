...
func (r *resourceMerger) MergeResources(kube resource.Managed, prov resource.Managed) plugin.MergeDescription {
	k := kube.(*ServiceDiscoveryPublicDnsNamespace)
	p := prov.(*ServiceDiscoveryPublicDnsNamespace)
	md := &plugin.MergeDescription{}
	updated := false
	anyChildUpdated := false

	updated = MergeServiceDiscoveryPublicDnsNamespace_Description(&k.Spec.ForProvider, &p.Spec.ForProvider, md)
	if updated {
	...
	updated = MergeServiceDiscoveryPublicDnsNamespace_Tags(&k.Spec.ForProvider, &p.Spec.ForProvider, md)
	if updated {
		anyChildUpdated = true
	}
