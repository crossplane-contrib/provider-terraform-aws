...
package v1alpha1func EncodeLaunchConfiguration(r LaunchConfiguration) cty.Value {
...
func EncodeLaunchConfiguration_EphemeralBlockDevice(p *EphemeralBlockDevice, vals map[string]cty.Value) {
	...
	for _, v := range p.EphemeralBlockDevice {
		...
		EncodeLaunchConfiguration_EphemeralBlockDevice_DeviceName(v, ctyVal)
		EncodeLaunchConfiguration_EphemeralBlockDevice_VirtualName(v, ctyVal)
...
func EncodeLaunchConfiguration_RootBlockDevice(p *RootBlockDevice, vals map[string]cty.Value) {
	...
	for _, v := range p.RootBlockDevice {
		ctyVal = make(map[string]cty.Value)
		EncodeLaunchConfiguration_RootBlockDevice_Iops(v, ctyVal)
		EncodeLaunchConfiguration_RootBlockDevice_VolumeSize(v, ctyVal)
		EncodeLaunchConfiguration_RootBlockDevice_VolumeType(v, ctyVal)
		EncodeLaunchConfiguration_RootBlockDevice_DeleteOnTermination(v, ctyVal)
		EncodeLaunchConfiguration_RootBlockDevice_Encrypted(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeLaunchConfiguration_EbsBlockDevice(p *EbsBlockDevice, vals map[string]cty.Value) {
	...
	for _, v := range p.EbsBlockDevice {
		ctyVal = make(map[string]cty.Value)
		EncodeLaunchConfiguration_EbsBlockDevice_DeviceName(v, ctyVal)
		EncodeLaunchConfiguration_EbsBlockDevice_Encrypted(v, ctyVal)
		EncodeLaunchConfiguration_EbsBlockDevice_Iops(v, ctyVal)
		EncodeLaunchConfiguration_EbsBlockDevice_NoDevice(v, ctyVal)
		EncodeLaunchConfiguration_EbsBlockDevice_SnapshotId(v, ctyVal)
		EncodeLaunchConfiguration_EbsBlockDevice_VolumeSize(v, ctyVal)
		EncodeLaunchConfiguration_EbsBlockDevice_VolumeType(v, ctyVal)
		EncodeLaunchConfiguration_EbsBlockDevice_DeleteOnTermination(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
