...
func (mg *Ec2TransitGatewayPeeringAttachmentAccepter) GetCondition(ct runtimev1alpha1.ConditionType) runtimev1alpha1.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this Ec2TransitGatewayPeeringAttachmentAccepter.
func (mg *Ec2TransitGatewayPeeringAttachmentAccepter) GetDeletionPolicy() runtimev1alpha1.DeletionPolicy {
...
*/
func (mg *Ec2TransitGatewayPeeringAttachmentAccepter) GetProviderReference() *runtimev1alpha1.Reference {
...
func (mg *Ec2TransitGatewayPeeringAttachmentAccepter) SetConditions(c ...runtimev1alpha1.Condition) {
	mg.Status.SetConditions(c...)
}

// SetDeletionPolicy of this Ec2TransitGatewayPeeringAttachmentAccepter.
func (mg *Ec2TransitGatewayPeeringAttachmentAccepter) SetDeletionPolicy(r runtimev1alpha1.DeletionPolicy) {
...
*/
func (mg *Ec2TransitGatewayPeeringAttachmentAccepter) SetProviderReference(r *runtimev1alpha1.Reference) {
