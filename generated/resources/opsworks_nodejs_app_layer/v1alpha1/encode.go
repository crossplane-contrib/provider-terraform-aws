...
package v1alpha1func EncodeOpsworksNodejsAppLayer(r OpsworksNodejsAppLayer) cty.Value {
...
func EncodeOpsworksNodejsAppLayer_EbsVolume(p *EbsVolume, vals map[string]cty.Value) {
	...
	for _, v := range p.EbsVolume {
		...
		EncodeOpsworksNodejsAppLayer_EbsVolume_MountPoint(v, ctyVal)
		EncodeOpsworksNodejsAppLayer_EbsVolume_NumberOfDisks(v, ctyVal)
		EncodeOpsworksNodejsAppLayer_EbsVolume_RaidLevel(v, ctyVal)
		EncodeOpsworksNodejsAppLayer_EbsVolume_Size(v, ctyVal)
		EncodeOpsworksNodejsAppLayer_EbsVolume_Type(v, ctyVal)
		EncodeOpsworksNodejsAppLayer_EbsVolume_Encrypted(v, ctyVal)
		EncodeOpsworksNodejsAppLayer_EbsVolume_Iops(v, ctyVal)
