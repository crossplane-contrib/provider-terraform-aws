...
package v1alpha1func EncodeCloudwatchMetricAlarm(r CloudwatchMetricAlarm) cty.Value {
...
func EncodeCloudwatchMetricAlarm_EvaluationPeriods(p *CloudwatchMetricAlarmParameters, vals map[string]cty.Value) {
	vals["evaluation_periods"] = cty.IntVal(p.EvaluationPeriods)
}
...
func EncodeCloudwatchMetricAlarm_Period(p *CloudwatchMetricAlarmParameters, vals map[string]cty.Value) {
	vals["period"] = cty.IntVal(p.Period)
}
...
func EncodeCloudwatchMetricAlarm_DatapointsToAlarm(p *CloudwatchMetricAlarmParameters, vals map[string]cty.Value) {
	vals["datapoints_to_alarm"] = cty.IntVal(p.DatapointsToAlarm)
}
...
func EncodeCloudwatchMetricAlarm_MetricQuery(p *MetricQuery, vals map[string]cty.Value) {
	...
	for _, v := range p.MetricQuery {
		ctyVal = make(map[string]cty.Value)
		EncodeCloudwatchMetricAlarm_MetricQuery_Expression(v, ctyVal)
		EncodeCloudwatchMetricAlarm_MetricQuery_Id(v, ctyVal)
		EncodeCloudwatchMetricAlarm_MetricQuery_Label(v, ctyVal)
		EncodeCloudwatchMetricAlarm_MetricQuery_ReturnData(v, ctyVal)
		EncodeCloudwatchMetricAlarm_MetricQuery_Metric(v.Metric, ctyVal)
...
func EncodeCloudwatchMetricAlarm_MetricQuery_Metric(p *Metric, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.Metric {
		ctyVal = make(map[string]cty.Value)
		EncodeCloudwatchMetricAlarm_MetricQuery_Metric_MetricName(v, ctyVal)
		EncodeCloudwatchMetricAlarm_MetricQuery_Metric_Namespace(v, ctyVal)
		EncodeCloudwatchMetricAlarm_MetricQuery_Metric_Period(v, ctyVal)
		EncodeCloudwatchMetricAlarm_MetricQuery_Metric_Stat(v, ctyVal)
		EncodeCloudwatchMetricAlarm_MetricQuery_Metric_Unit(v, ctyVal)
		EncodeCloudwatchMetricAlarm_MetricQuery_Metric_Dimensions(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
