...
package v1alpha1func EncodeRdsCluster(r RdsCluster) cty.Value {
...
func EncodeRdsCluster_BacktrackWindow(p *RdsClusterParameters, vals map[string]cty.Value) {
	vals["backtrack_window"] = cty.IntVal(p.BacktrackWindow)
}
...
func EncodeRdsCluster_BackupRetentionPeriod(p *RdsClusterParameters, vals map[string]cty.Value) {
	vals["backup_retention_period"] = cty.IntVal(p.BackupRetentionPeriod)
}
...
func EncodeRdsCluster_S3Import(p *S3Import, vals map[string]cty.Value) {
	...
	for _, v := range p.S3Import {
		ctyVal = make(map[string]cty.Value)
		EncodeRdsCluster_S3Import_BucketName(v, ctyVal)
		EncodeRdsCluster_S3Import_BucketPrefix(v, ctyVal)
		EncodeRdsCluster_S3Import_IngestionRole(v, ctyVal)
		EncodeRdsCluster_S3Import_SourceEngine(v, ctyVal)
		EncodeRdsCluster_S3Import_SourceEngineVersion(v, ctyVal)
...
func EncodeRdsCluster_ScalingConfiguration(p *ScalingConfiguration, vals map[string]cty.Value) {
	valsForCollection = make([]cty.Value, 0)
	for _, v := range p.ScalingConfiguration {
		ctyVal = make(map[string]cty.Value)
		EncodeRdsCluster_ScalingConfiguration_AutoPause(v, ctyVal)
		EncodeRdsCluster_ScalingConfiguration_MaxCapacity(v, ctyVal)
		EncodeRdsCluster_ScalingConfiguration_MinCapacity(v, ctyVal)
		EncodeRdsCluster_ScalingConfiguration_SecondsUntilAutoPause(v, ctyVal)
		EncodeRdsCluster_ScalingConfiguration_TimeoutAction(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
...
func EncodeRdsCluster_ScalingConfiguration_SecondsUntilAutoPause(p *ScalingConfiguration, vals map[string]cty.Value) {
	vals["seconds_until_auto_pause"] = cty.IntVal(p.SecondsUntilAutoPause)
}
