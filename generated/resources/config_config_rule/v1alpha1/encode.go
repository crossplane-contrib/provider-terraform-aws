...
package v1alpha1func EncodeConfigConfigRule(r ConfigConfigRule) cty.Value {
...
func EncodeConfigConfigRule_Source(p *Source, vals map[string]cty.Value) {
	...
	for _, v := range p.Source {
		...
		EncodeConfigConfigRule_Source_Owner(v, ctyVal)
		EncodeConfigConfigRule_Source_SourceIdentifier(v, ctyVal)
		EncodeConfigConfigRule_Source_SourceDetail(v.SourceDetail, ctyVal)
...
func EncodeConfigConfigRule_Scope(p *Scope, vals map[string]cty.Value) {
	...
	for _, v := range p.Scope {
		ctyVal = make(map[string]cty.Value)
		EncodeConfigConfigRule_Scope_ComplianceResourceId(v, ctyVal)
		EncodeConfigConfigRule_Scope_ComplianceResourceTypes(v, ctyVal)
		EncodeConfigConfigRule_Scope_TagKey(v, ctyVal)
		EncodeConfigConfigRule_Scope_TagValue(v, ctyVal)
		valsForCollection = append(valsForCollection, cty.ObjectVal(ctyVal))
	}
